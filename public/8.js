...
var _efecto = __webpack_require__(719);

var _efecto2 = _interopRequireDefault(_efecto);
...
var Eli3 = function (_Component) {
	_inherits(Eli3, _Component);

	function Eli3(props) {
		_classCallCheck(this, Eli3);

		var _this = _possibleConstructorReturn(this, (Eli3.__proto__ || Object.getPrototypeOf(Eli3)).call(this, props));

		_this.state = {
			effect: ""
		};
		_this.handleClick = _this.handleClick.bind(_this);
		_this.Omitir = _this.Omitir.bind(_this);
		return _this;
	}
...
function mapDispatchToProps(dispatch) {
	return {
		chromaEffect: function chromaEffect(effect) {
			return dispatch((0, _index.chromaEffect)(effect));
		}
	};
}

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(Eli3);
...
module.exports = "/images/efecto.png?1079573cb3c139f22698a1f1c4f00626";
