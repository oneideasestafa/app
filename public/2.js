...
var _logoOne = __webpack_require__(131);

var _logoOne2 = _interopRequireDefault(_logoOne);

var _GoogleAuthButton = __webpack_require__(180);

var _GoogleAuthButton2 = _interopRequireDefault(_GoogleAuthButton);

var _FacebookAuthButton = __webpack_require__(181);
...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function handleLogin(e) {
      ...
      this.props.authenticate(email, password).catch(function (error) {
        var message = '';
        ...
        return _this2.props.appFinishLoading();
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var urlRecuperar = "/recovery-password";
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "input-group mb-4 mt-3" },
            _react2.default.createElement(
              "div",
              { className: "input-group-prepend" },
        ...
        _react2.default.createElement(
          "p",
          { className: "mt-3 text-center link-recovery-password roboto-condensed" },
          _react2.default.createElement(
            "a",
            { href: urlRecuperar },
            "\xBFHas olvidado tu contrase\xF1a?"
          )
        )
      );
    }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    authenticate: function authenticate(email, password) {
      return dispatch((0, _auth.authenticate)(email, password));
    },
