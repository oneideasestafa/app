(function(e) {
    ...
    return function() {
        ...
        2: [function(e, t) {
            (function(n) {
                const {
                    ...
                    PassThrough: o
                } = e("readable-stream"), i = e("end-of-stream"), a = e("path"), l = e("render-media"), c = e("stream-to-blob"), u = e("stream-to-blob-url"), p = e("stream-with-known-length-to-buffer"), f = e("./file-stream");
                class h extends r {
                    constructor(e, t) {
                    ...
                    get downloaded() {
                        ...
                        let a = t.get(r) ? n - this.offset % n : s(i.length - i.missing - this.offset, 0);
                        for (let i = r + 1; i <= o; ++i)
                            if (t.get(i)) a += n;
                            else {
                                const t = e[i];
                                a += t.length - t.missing
                            }
                    ...
                    getBuffer(e) {
                        p(this.createReadStream(), this.length, e)
                    }
                    getBlob(e) {
                        if ("undefined" == typeof window) throw new Error("browser-only method");
                        c(this.createReadStream(), this._getMimeType(), e)
                    }
                    getBlobURL(e) {
                        if ("undefined" == typeof window) throw new Error("browser-only method");
            ...
            "render-media": 169,
            "stream-to-blob": 222,
            "stream-to-blob-url": 221,
            "stream-with-known-length-to-buffer": 223
        }],
        3: [function(e, t, n) {
            ...
            n.createWebRTCPeer = (e, t) => {
                ...
                const t = `${e.remoteAddress}:${e.remotePort}`,
                    n = new s(t, "tcpIncoming");
                return n.conn = e, n.addr = t, n.onConnect(), n
            }, n.createTCPOutgoingPeer = (e, t) => {
                const n = new s(e, "tcpOutgoing");
                return n.addr = e, n.swarm = t, n
            }, n.createWebSeedPeer = (e, t) => {
                const n = new s(e, "webSeed");
                return n.swarm = t, n.conn = new a(e, t), n.onConnect(), n
            };
            class s {
                constructor(e, t) {
                    this.id = e, this.type = t, o("new %s Peer %s", t, e), this.addr = null, this.conn = null, this.swarm = null, this.wire = null, this.connected = !1, this.destroyed = !1, this.timeout = null, this.retries = 0, this.sentHandshake = !1
                }
                onConnect() {
                    if (!this.destroyed) {
                        this.connected = !0, o("Peer %s connected", this.id), clearTimeout(this.connectTimeout);
                        const e = this.conn;
                        e.once("end", () => {
                            this.destroy()
                        }), e.once("close", () => {
                ...
                onHandshake(e, t) {
                    ...
                    o("Peer %s got handshake %s", this.id, e), clearTimeout(this.handshakeTimeout), this.retries = 0;
                    let n = this.addr;
                ...
                destroy(e) {
                    if (this.destroyed) return;
                    this.destroyed = !0, this.connected = !1, o("destroy %s (error: %s)", this.id, e && (e.message || e)), clearTimeout(this.connectTimeout), clearTimeout(this.handshakeTimeout);
                    const t = this.swarm,
                        n = this.conn,
                        i = this.wire;
                    this.swarm = null, this.conn = null, this.wire = null, t && i && r(t.wires, t.wires.indexOf(i)), n && (n.on("error", () => {}), n.destroy()), i && i.destroy(), t && t.removePeer(this.id)
                }
            }
        }, {
            "./webconn": 6,
        ...
        5: [function(e, t) {
            (function(n, r) {
                function o(e, t) {
                    return 2 + a(t * e.downloadSpeed() / I.BLOCK_LENGTH)
                }
                ...
                let Y;
                try {
                    Y = L.join(b.statSync("/tmp") && "/tmp", "webtorrent")
                } catch (e) {
                    Y = L.join("function" == typeof C.tmpdir ? C.tmpdir() : "/", "webtorrent")
                }
                class X extends _ {
                    constructor(e, t, n) {
                        super(), this._debugId = "unknown infohash", this.client = t, this.announce = n.announce, this.urlList = n.urlList, this.path = n.path, this.skipVerify = !!n.skipVerify, this._store = n.store || i, this._getAnnounceOpts = n.getAnnounceOpts, this.strategy = n.strategy || "sequential", this.maxWebConns = n.maxWebConns || 4, this._rechokeNumSlots = !1 === n.uploads || 0 === n.uploads ? 0 : +n.uploads || 10, this._rechokeOptimisticWire = null, this._rechokeOptimisticTime = 0, this._rechokeIntervalId = null, this.ready = !1, this.destroyed = !1, this.paused = !1, this.done = !1, this.metadata = null, this.store = null, this.files = [], this.pieces = [], this._amInterested = !1, this._selections = [], this._critical = [], this.wires = [], this._queue = [], this._peers = {}, this._peersLength = 0, this.received = 0, this.uploaded = 0, this._downloadSpeed = A(), this._uploadSpeed = A(), this._servers = [], this._xsRequests = [], this._fileModtimes = n.fileModtimes, null !== e && this._onTorrentId(e), this._debug("new torrent")
                    }
                    get timeRemaining() {
                    ...
                    _onTorrentId(e) {
                        ...
                        t ? (this.infoHash = t.infoHash, this._debugId = t.infoHash.toString("hex").substring(0, 7), n.nextTick(() => {
                    ...
                    _onParsedTorrent(e) {
                        if (!this.destroyed) {
                            ...
                            (this.path || (this.path = L.join(Y, this.infoHash)), this._rechokeIntervalId = setInterval(() => {
                                this._rechoke()
                        ...
                        e && (e = Object.assign({}, this.client.tracker, {
                            getAnnounceOpts: () => {
                                const e = {
                                    ...
                                    left: s(this.length - this.downloaded, 0)
                                };
                    ...
                    _getMetadataFromServer() {
                        function e(e, n) {
                            function r(r, o, i) {
                                ...
                                return a ? a.infoHash === t.infoHash ? void(t._onMetadata(a), n(null)) : (t.emit("warning", new Error(`got torrent file with incorrect info hash from xs param: ${e}`)), n(null)) : (t.emit("warning", new Error(`got invalid torrent file from xs param: ${e}`)), n(null))
                            }
                    ...
                    _onMetadata(e) {
                        ...
                        if (this._processParsedTorrent(t), this.metadata = this.torrentFile, this.client.enableWebSeeds && this.urlList.forEach(e => {
                                this.addWebSeed(e)
                            }), this._rarityMap = new F(this), this.store = new w(new this._store(this.pieceLength, {
                                torrent: {
                                    infoHash: this.infoHash
                                },
                                files: this.files.map(e => ({
                                    path: L.join(this.path, e.path),
                                    length: e.length,
                                    offset: e.offset
                                })),
                                length: this.length,
                                name: this.infoHash
                            })), this.files = this.files.map(e => new j(this, e)), this.so) {
                            const e = O.parse(this.so);
                        ...
                        this._hashes = this.pieces, this.pieces = this.pieces.map((e, t) => {
                            ...
                            return new I(n)
                        }), this._reservations = this.pieces.map(() => []), this.bitfield = new f(this.pieces.length), this.wires.forEach(e => {
                            e.ut_metadata && e.ut_metadata.setMetadata(this.metadata), this._onWireWithMetadata(e)
                        }), this.skipVerify ? (this._markAllVerified(), this._onStore()) : (this._debug("verifying existing torrent data"), this._fileModtimes && this._store === i ? this.getFileModtimes((e, t) => {
                    ...
                    getFileModtimes(e) {
                        ...
                        v(this.files.map((e, n) => r => {
                            b.stat(L.join(this.path, e.path), (e, o) => e && "ENOENT" !== e.code ? r(e) : void(t[n] = o && o.mtime.getTime(), r(null)))
                        }), z, n => {
                            this._debug("done getting file modtimes"), e(n, t)
                        })
                    }
                    _verifyPieces() {
                        v(this.pieces.map((e, t) => e => this.destroyed ? e(new Error("torrent is destroyed")) : void this.store.get(t, (r, o) => this.destroyed ? e(new Error("torrent is destroyed")) : r ? n.nextTick(e, null) : void R(o, n => {
                            ...
                            e(null)
                        }))), z, e => e ? this._destroy(e) : void(this._debug("done verifying"), this._onStore()))
                    }
                    _markAllVerified() {
                    ...
                    addPeer(t) {
                        ...
                        return n ? this.emit("peer", t) : this.emit("invalidPeer", t), n
                    }
                    _addPeer(e) {
                        ...
                        let n;
                        return n = "string" == typeof e ? N.createTCPOutgoingPeer(e, this) : N.createWebRTCPeer(e, this), this._peers[n.id] = n, this._peersLength += 1, "string" == typeof e && (this._queue.push(n), this._drain()), n
                    }
                    addWebSeed(e) {
                        if (this.destroyed) throw new Error("torrent is destroyed");
                        ...
                        const t = N.createWebSeedPeer(e, this);
                    ...
                    _onWire(e, t) {
                        ...
                        this.client.dht && this.client.dht.listening && e.on("port", n => this.destroyed || this.client.dht.destroyed ? void 0 : e.remoteAddress ? 0 === n || 65536 < n ? this._debug("ignoring invalid PORT from peer") : void(this._debug("port: %s (from %s)", n, t), this.client.dht.addNode({
                        ...
                        }), e.setTimeout(3e4, !0), e.setKeepAlive(!0), e.use(P(this.metadata)), e.ut_metadata.on("warning", e => {
                        ...
                        }), e.ut_metadata.fetch()), "function" != typeof M || this.private || (e.use(M()), e.ut_pex.on("peer", e => {
                            ...
                            e.ut_pex.reset()
                        })), this.emit("wire", e, t), this.metadata && n.nextTick(() => {
                    ...
                    _onWireWithMetadata(e) {
                        let t = null;
                        const n = () => {
                            this.destroyed || e.destroyed || (this._numQueued > 2 * (this._numConns - this.numPeers) && e.amInterested ? e.destroy() : (t = setTimeout(n, q), t.unref && t.unref()))
                        };
                        let r;
                        const o = () => {
                        ...
                        e.on("bitfield", () => {
                            ...
                            clearTimeout(t), t = setTimeout(n, q), t.unref && t.unref()
                        }), e.on("unchoke", () => {
                            clearTimeout(t), this._update()
                        }), e.on("request", (t, n, r, o) => r > 131072 ? e.destroy() : void(this.pieces[t] || this.store.get(t, {
                            offset: n,
                            length: r
                        }, o))), e.bitfield(this.bitfield), e.uninterested(), e.peerExtensions.dht && this.client.dht && this.client.dht.listening && e.port(this.client.dht.address().port), "webSeed" !== e.type && (t = setTimeout(n, q), t.unref && t.unref()), e.isSeeder = !1, o()
                    }
                    _updateSelections() {
                        !this.ready || this.destroyed || (n.nextTick(() => {
                            this._gcSelections()
                    ...
                    _updateWire(e) {
                        function t(t, n, r, o) {
                            return a => a >= t && a <= n && !(a in r) && e.peerPieces.get(a) && (!o || o(a))
                        }

                        function n() {
                            const t = e.downloadSpeed() || 1;
                            if (t > D) return () => !0;
                            const n = s(1, e.requests.length) * I.BLOCK_LENGTH / t;
                            let r = 10,
                                o = 0;
                            return e => {
                                ...
                                for (let i = a.pieces[e].missing; o < a.wires.length; o++) {
                                    const s = a.wires[o],
                                        d = s.downloadSpeed();
                                    if (!(d < D) && !(d <= t) && s.peerPieces.get(e) && !(0 < (i -= d * n))) return r--, !1
                                }
                                return !0
                            }
                        }
                        ...
                        function r(e) {
                            let t = e;
                            for (let n = e; n < a._selections.length && a._selections[n].priority; n++) t = n;
                            ...
                            for (let n = 0; n < a._selections.length; n++) {
                                ...
                                if ("rarest" === a.strategy) {
                                    const c = i.from + i.offset,
                                        ...
                                        p = {};
                                    let f = 0;
                                    for (const h = t(c, u, p, s); f < u - c + 1 && (d = a._rarityMap.getRarestPiece(h), !(0 > d));) {
                                        for (; a._request(e, d, a._critical[d] || o););
                                    ...
                                    for (d = i.from + i.offset; d <= i.to; d++)
                                        if (e.peerPieces.get(d) && s(d)) {
                                            for (; a._request(e, d, a._critical[d] || o););
                                            if (!(e.requests.length < l)) return i.priority && r(n), !0
                                        }
                            }
                            return !1
                        }
                                ...
                                for (let n = a._selections.length; n--;) {
                                    ...
                                    if ("rarest" === a.strategy) {
                                        const n = r.from + r.offset,
                                            ...
                                            s = {};
                                        let d = 0;
                                        for (const r = t(n, i, s); d < i - n + 1 && (o = a._rarityMap.getRarestPiece(r), !(0 > o));) {
                                            if (a._request(e, o, !1)) return;
                                            s[o] = !0, d += 1
                                        }
                                    } else
                                        for (o = r.to; o >= r.from + r.offset; --o)
                                            if (e.peerPieces.get(o) && a._request(e, o, !1)) return
                                }
                        }();
                        const d = o(e, .5);
                        if (e.requests.length >= d) return;
                        const l = o(e, W);
                        i(!1) || i(!0)
                    }
                    _rechoke() {
                    ...
                    _hotswap(e, t) {
                        ...
                        for (s = 0; s < o.length; s++) {
                            ...
                            i >= D || 2 * i > n || i > r || (a = t, r = i)
                        }
                        if (!a) return !1;
                        for (s = 0; s < o.length; s++) o[s] === a && (o[s] = null);
                        for (s = 0; s < a.requests.length; s++) {
                            const e = a.requests[s];
                            e.piece === t && this.pieces[t].cancel(0 | e.offset / I.BLOCK_LENGTH)
                        }
                    ...
                    _request(e, t, a) {
                        ...
                        const f = p ? d(l(e, W, c.pieceLength), c.maxWebConns) : o(e, W);
                        if (u >= f) return !1;
                        const h = c.pieces[t];
                        let m = p ? h.reserveRemaining() : h.reserve();
                        if (-1 === m && a && c._hotswap(e, t) && (m = p ? h.reserveRemaining() : h.reserve()), -1 === m) return !1;
                        let g = c._reservations[t];
                        g || (g = c._reservations[t] = []);
                        let _ = g.indexOf(null); - 1 === _ && (_ = g.length), g[_] = e;
                        const b = h.chunkOffset(m),
                            y = p ? h.chunkLengthRemaining(m) : h.chunkLength(m);
                        return e.request(t, b, y, function n(r, o) {
                            if (c.destroyed) return;
                            if (!c.ready) return c.once("ready", () => {
                                n(r, o)
                            });
                            if (g[_] === e && (g[_] = null), h !== c.pieces[t]) return s();
                            if (r) return c._debug("error getting piece %s (offset: %s length: %s) from %s: %s", t, b, y, `${e.remoteAddress}:${e.remotePort}`, r.message), p ? h.cancelRemaining(m) : h.cancel(m), void s();
                            if (c._debug("got piece %s (offset: %s length: %s) from %s", t, b, y, `${e.remoteAddress}:${e.remotePort}`), !h.set(m, o, e)) return s();
                            const i = h.flush();
                            R(i, e => {
                                if (!c.destroyed) {
                                    if (e === c._hashes[t]) {
                                        if (!c.pieces[t]) return;
                                        c._debug("piece verified %s", t), c.pieces[t] = null, c._reservations[t] = null, c.bitfield.set(t, !0), c.store.put(t, i), c.wires.forEach(e => {
                                            e.have(t)
                                        }), c._checkDone() && !c.destroyed && c.discovery.complete()
                                    } else c.pieces[t] = new I(h.length), c.emit("warning", new Error(`Piece ${t} failed verification`));
                                    s()
                                }
                            })
                        }), !0
                    ...
                    load(e, t) {
                        ...
                        B(n, r, e => e ? t(e) : void(this._markAllVerified(), this._checkDone(), t(null)))
                    }
                    createServer(e) {
                        if ("function" != typeof H) throw new Error("node.js-only method");
                        if (this.destroyed) throw new Error("torrent is destroyed");
                    ...
                    _debug() {
                        ...
                        e[0] = `[${this.client._debugId}] [${this._debugId}] ${e[0]}`, m(...e)
                    }
                    _drain() {
                        if (this._debug("_drain numConns %s maxConns %s", this._numConns, this.client.maxConns), "function" != typeof x.connect || this.destroyed || this.paused || this._numConns >= this.client.maxConns) return;
                        ...
                        r.once("connect", () => {
                            ...
                            if (!this.destroyed) {
                                if (e.retries >= V.length) return void this._debug("conn %s closed: will not re-add (max %s attempts)", e.addr, V.length);
                                const t = V[e.retries];
            ...
            "addr-to-ip-port": 7,
            bitfield: 13,
            "chunk-store-stream/write": 64,
            debug: 69,
            events: 48,
            fs: 46,
            "fs-chunk-store": 105,
            "immediate-chunk-store": 86,
            multistream: 121,
            net: 45,
            os: 45,
            "parse-numeric-range": 133,
            "parse-torrent": 134,
            path: 135,
            pump: 139,
            "random-iterate": 144,
            "run-parallel": 175,
            "run-parallel-limit": 174,
            "simple-get": 179,
            "simple-sha1": 193,
            speedometer: 207,
            "torrent-discovery": 229,
            "torrent-piece": 233,
            uniq: 236,
            ut_metadata: 240,
            ut_pex: 45
        ...
        6: [function(e, t) {
            ...
            t.exports = class extends l {
                constructor(e, t) {
                    super(), this.url = e, this.webPeerId = a.sync(e), this._torrent = t, this._init()
                }
                _init() {
                ...
                httpRequest(e, t, n, a) {
                    ...
                    if (1 >= f.length) h = [{
                        ...
                        const e = f.filter(e => e.offset <= p && e.offset + e.length > u);
                        if (1 > e.length) return a(new Error("Could not find file corresponnding to web seed range request"));
                        h = e.map(e => {
                            const t = e.offset + e.length - 1,
                                n = this.url + ("/" === this.url[this.url.length - 1] ? "" : "/") + e.path;
                            return {
                                url: n,
                                fileOffsetInRange: s(e.offset - u, 0),
                                start: s(u - e.offset, 0),
                                end: d(t, p - e.offset)
                            }
                        })
                    }
                    let m = 0,
                        g = !1,
                        _;
                    1 < h.length && (_ = r.alloc(n)), h.forEach(r => {
                        function s(e, t) {
                            return 200 > e.statusCode || 300 <= e.statusCode ? (g = !0, a(new Error(`Unexpected HTTP status code ${e.statusCode}`))) : void(o("Got data of length %d", t.length), 1 === h.length ? a(null, t) : (t.copy(_, r.fileOffsetInRange), ++m === h.length && a(null, _)))
                        }
                        const d = r.url,
                            l = r.start,
                            u = r.end;
                        o("Requesting url=%s pieceIndex=%d offset=%d length=%d start=%d end=%d", d, e, t, n, l, u);
                        const p = {
                            url: d,
                            method: "GET",
                            headers: {
        ...
        8: [function(e, t, n) {
            ...
            function a(e) {
                for (var t = r(e), n = t[0], a = t[1], s = new p(o(e, n, a)), d = 0, l = 0 < a ? n - 4 : n, c = 0, f; c < l; c += 4) f = u[e.charCodeAt(c)] << 18 | u[e.charCodeAt(c + 1)] << 12 | u[e.charCodeAt(c + 2)] << 6 | u[e.charCodeAt(c + 3)], s[d++] = 255 & f >> 16, s[d++] = 255 & f >> 8, s[d++] = 255 & f;
                return 2 === a && (f = u[e.charCodeAt(c)] << 2 | u[e.charCodeAt(c + 1)] >> 4, s[d++] = 255 & f), 1 === a && (f = u[e.charCodeAt(c)] << 10 | u[e.charCodeAt(c + 1)] << 4 | u[e.charCodeAt(c + 2)] >> 2, s[d++] = 255 & f >> 8, s[d++] = 255 & f), s
            }
            ...
            function d(e, t, n) {
                for (var r = [], o = t, a; o < n; o += 3) a = (16711680 & e[o] << 16) + (65280 & e[o + 1] << 8) + (255 & e[o + 2]), r.push(s(a));
                return r.join("")
            }

            function l(e) {
                for (var t = e.length, n = t % 3, r = [], o = 16383, a = 0, s = t - n, l; a < s; a += o) r.push(d(e, a, a + o > s ? s : a + o));
            ...
            for (var c = [], u = [], p = "undefined" == typeof Uint8Array ? Array : Uint8Array, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", h = 0, m = f.length; h < m; ++h) c[h] = f[h], u[f.charCodeAt(h)] = h;
            u[45] = 62, u[95] = 63
        }, {}],
        9: [function(e, t) {
            (function(e) {
                function n(e, t, n) {
                    for (var r = 0, o = 1, a = t, s; a < n; a++) {
                        if (s = e[a], 58 > s && 48 <= s) {
                            r = 10 * r + (s - 48);
                            continue
                        }
                        if (a !== t || 43 !== s) {
                            ...
                            if (46 === s) break;
                            throw new Error("not a number: buffer[" + a + "] = " + s)
                        }
                    }
                    return r * o
                }
                ...
                r.bytes = 0, r.position = 0, r.data = null, r.encoding = null, r.next = function() {
                    ...
                    throw new Error("Invalid data: Missing delimiter \"" + o(e) + "\" [0x" + e.toString(16) + "]")
                }, r.dictionary = function() {
                    r.position++;
                    for (var e = {}; r.data[r.position] !== i;) e[r.buffer()] = r.next();
                    return r.position++, e
                }, r.list = function() {
                    r.position++;
                    for (var e = []; r.data[r.position] !== i;) e.push(r.next());
                    return r.position++, e
                }, r.integer = function() {
                    var e = r.find(i),
        ...
        10: [function(e, t) {
            function n(e, t, o) {
                var i = [],
                    a = null;
                return n._encode(i, e), a = r.concat(i), n.bytes = a.length, r.isBuffer(t) ? (a.copy(t, o), t) : a
            }
            ...
            n.buffer = function(e, t) {
                ...
                var o = (t / 2147483648 << 0) * 2147483648 + (t % 2147483648 << 0);
                e.push(r.from("i" + o + "e")), o === t || n._floatConversionDetected || (n._floatConversionDetected = !0, console.warn("WARNING: Possible data corruption detected with value \"" + t + "\":", "Bencoding only defines support for integers, value was converted to \"" + o + "\""), console.trace())
            }, n.dict = function(e, t) {
                e.push(i);
                for (var r = 0, a = Object.keys(t).sort(), s = a.length, d; r < s; r++) d = a[r], null == t[d] || (n.string(e, d), n._encode(e, t[d]));
                e.push(o)
            }, n.list = function(e, t) {
                var r = 0,
                    s = t.length;
                for (e.push(a); r < s; r++) null != t[r] && n._encode(e, t[r]);
                e.push(o)
            }, t.exports = n
        }, {
            "safe-buffer": 177
        ...
        12: [function(e, t) {
            t.exports = function(e, t, n, r, o) {
                ...
                for (; r <= o;)
                    if (i = r + (o - r >> 1), a = +n(e[i], t, i, e), 0 > a) r = i + 1;
                    else if (0 < a) o = i - 1;
                else return i;
                return ~r
            }
        ...
        13: [function(e, t) {
            (function(e) {
                ...
                var o = "undefined" == typeof e ? Uint8Array : e;
        ...
        14: [function(e, t) {
            (function(n) {
                ...
                class w extends c.Duplex {
                    constructor() {
                        super(), this._debugId = d(4).toString("hex"), this._debug("new wire"), this.peerId = null, this.peerIdBuffer = null, this.type = null, this.amChoking = !0, this.amInterested = !1, this.peerChoking = !0, this.peerInterested = !1, this.peerPieces = new i(0, {
                            grow: 4e5
                    ...
                    handshake(e, t, r) {
                        let o, i;
                        if ("string" == typeof e ? (e = e.toLowerCase(), o = n.from(e, "hex")) : (o = e, e = o.toString("hex")), "string" == typeof t ? i = n.from(t, "hex") : (i = t, t = i.toString("hex")), 20 !== o.length || 20 !== i.length) throw new Error("infoHash and peerId MUST have length 20");
                        this._debug("handshake i=%s p=%s exts=%o", e, t, r);
                        const a = n.from(_);
                        a[5] |= 16, r && r.dht && (a[7] |= 1), this._push(n.concat([u, a, o, i])), this._handshakeSent = !0, this.peerExtensions.extended && !this._extendedHandshakeSent && this._sendExtendedHandshake()
                    }
                    _sendExtendedHandshake() {
                        const e = s(this.extendedHandshake);
                        for (const t in e.m = {}, this.extendedMapping) {
                            const n = this.extendedMapping[t];
                            e.m[n] = +t
                        }
                        this.extended(0, o.encode(e)), this._extendedHandshakeSent = !0
                    }
                    choke() {
                        if (!this.amChoking) {
                    ...
                    unchoke() {
                        this.amChoking && (this.amChoking = !1, this._debug("unchoke"), this._push(h))
                    }
                    interested() {
                        this.amInterested || (this.amInterested = !0, this._debug("interested"), this._push(m))
                    }
                    uninterested() {
                        this.amInterested && (this.amInterested = !1, this._debug("uninterested"), this._push(g))
                    }
                    have(e) {
                    ...
                    request(e, t, n, r) {
                        return r || (r = () => {}), this._finished ? r(new Error("wire is closed")) : this.peerChoking ? r(new Error("peer is choking")) : void(this._debug("request index=%d offset=%d length=%d", e, t, n), this.requests.push(new y(e, t, n, r)), this._updateTimeout(), this._message(6, [e, t, n], null))
                    }
                    piece(e, t, n) {
                    ...
                    _message(e, t, r) {
                        ...
                        for (let n = 0; n < t.length; n++) a.writeUInt32BE(t[n], 5 + 4 * n);
                    ...
                    _onBitField(e) {
                        this.peerPieces = new i(e), this._debug("got bitfield"), this.emit("bitfield", this.peerPieces)
                    }
                    _onRequest(e, t, n) {
                        if (!this.amChoking) {
                            this._debug("got request index=%d offset=%d length=%d", e, t, n);
                            const o = (o, i) => r === this._pull(this.peerRequests, e, t, n) ? o ? this._debug("error satisfying request index=%d offset=%d length=%d (%s)", e, t, n, o.message) : void this.piece(e, t, i) : void 0;
                            var r = new y(e, t, n, o);
                    ...
                    _pull(e, t, n, o) {
                        for (let a = 0; a < e.length; a++) {
                            const i = e[a];
                            if (i.piece === t && i.offset === n && i.length === o) return r(e, a), i
                        }
                        return null
                    }
                }
        ...
        15: [function(e, t, n) {
            (function(o) {
                ...
                n.log = a, n.formatArgs = function(e) {
        ...
        16: [function(e, t) {
            t.exports = function(t) {
                function n(e) {
                    ...
                    return o.colors[r(t) % o.colors.length]
                }
                    ...
                    function t() {
                        if (t.enabled) {
                            ...
                            var a = t,
                                s = +new Date,
                                d = s - (r || s);
                            a.diff = d, a.prev = r, a.curr = s, r = s, n[0] = o.coerce(n[0]), "string" != typeof n[0] && n.unshift("%O");
                            var l = 0;
                            n[0] = n[0].replace(/%([a-zA-Z%])/g, function(e, t) {
                                ...
                                if ("function" == typeof r) {
                                    var i = n[l];
                                    e = r.call(a, i), n.splice(l, 1), l--
                                }
                                return e
                            }), o.formatArgs.call(a, n);
                            var c = a.log || o.log;
                            c.apply(a, n)
                        }
                    }
                    var r;
                    return t.namespace = e, t.enabled = o.enabled(e), t.useColors = o.useColors(), t.color = n(e), t.destroy = i, t.extend = a, "function" == typeof o.init && o.init(t), o.instances.push(t), t
                }
                ...
                function a(e, t) {
                    return o(this.namespace + ("undefined" == typeof t ? ":" : t) + e)
                }
                return o.debug = o, o.default = o, o.coerce = function(e) {
                    ...
                    var t = ("string" == typeof e ? e : "").split(/[\s,]+/),
                        n = t.length,
                        r;
                    for (r = 0; r < n; r++) t[r] && (e = t[r].replace(/\*/g, ".*?"), "-" === e[0] ? o.skips.push(new RegExp("^" + e.substr(1) + "$")) : o.names.push(new RegExp("^" + e + "$")));
                    for (r = 0; r < o.instances.length; r++) {
                        var a = o.instances[r];
                    ...
                    return !1
                }, o.humanize = e("ms"), Object.keys(t).forEach(function(e) {
                    o[e] = t[e]
                }), o.instances = [], o.names = [], o.skips = [], o.formatters = {}, o.selectColor = n, o.enable(o.load()), o
            }
        }, {
            ms: 17
        }],
        17: [function(e, t) {
            ...
            function i(e) {
                var t = r(e);
                return 86400000 <= t ? a(e, t, 86400000, "day") : 3600000 <= t ? a(e, t, 3600000, "hour") : 60000 <= t ? a(e, t, 60000, "minute") : 1000 <= t ? a(e, t, 1000, "second") : e + " ms"
            }
        ...
        18: [function(e, t) {
            ...
            s.inherits(n, d);
            for (var c = a(l.prototype), u = 0, p; u < c.length; u++) p = c[u], n.prototype[p] || (n.prototype[p] = l.prototype[p]);
        ...
        20: [function(e, t) {
            (function(r, o) {
                ...
                function d(t, r) {
                    ...
                    var o = r instanceof M;
                    this.objectMode = !!t.objectMode, o && (this.objectMode = this.objectMode || !!t.readableObjectMode);
                    var i = t.highWaterMark,
                        a = t.readableHighWaterMark,
                        s = this.objectMode ? 16 : 16384;
                    this.highWaterMark = i || 0 === i ? i : o && (a || 0 === a) ? a : s, this.highWaterMark = n(this.highWaterMark), this.buffer = new z, this.length = 0, this.pipes = null, this.pipesCount = 0, this.flowing = null, this.ended = !1, this.endEmitted = !1, this.reading = !1, this.sync = !0, this.needReadable = !1, this.emittedReadable = !1, this.readableListening = !1, this.resumeScheduled = !1, this.destroyed = !1, this.defaultEncoding = t.defaultEncoding || "utf8", this.awaitDrain = 0, this.readingMore = !1, this.decoder = null, this.encoding = null, t.encoding && (!G && (G = e("string_decoder/").StringDecoder), this.decoder = new G(t.encoding), this.encoding = t.encoding)
                }

                function l(t) {
                    return M = M || e("./_stream_duplex"), this instanceof l ? void(this._readableState = new d(t, this), this.readable = !0, t && ("function" == typeof t.read && (this._read = t.read), "function" == typeof t.destroy && (this._destroy = t.destroy)), N.call(this)) : new l(t)
                }
                ...
                function c(e, t, n, r, o) {
                    ...
                    if (null === t) a.reading = !1, g(e, a);
                        ...
                        var s;
                        o || (s = p(a, t)), s ? e.emit("error", s) : a.objectMode || t && 0 < t.length ? ("string" != typeof t && !a.objectMode && Object.getPrototypeOf(t) !== F.prototype && (t = i(t)), r ? a.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : u(e, a, t, !0) : a.ended ? e.emit("error", new Error("stream.push() after EOF")) : (a.reading = !1, a.decoder && !n ? (t = a.decoder.write(t), a.objectMode || 0 !== t.length ? u(e, a, t, !1) : y(e, a)) : u(e, a, t, !1))) : !r && (a.reading = !1)
                    }
                    return f(a)
                }
                ...
                function p(e, t) {
                    var n;
                    return a(t) || "string" == typeof t || void 0 === t || e.objectMode || (n = new TypeError("Invalid non-string/buffer chunk")), n
                }
                ...
                function _(e) {
                    ...
                    t.needReadable = !1, t.emittedReadable || (W("emitReadable", t.flowing), t.emittedReadable = !0, t.sync ? U.nextTick(b, e) : b(e))
                }

                function b(e) {
                    W("emit readable"), e.emit("readable"), v(e)
                }

                function y(e, t) {
                    t.readingMore || (t.readingMore = !0, U.nextTick(w, e, t))
                }

                function w(e, t) {
                    for (var n = t.length; !t.reading && !t.flowing && !t.ended && t.length < t.highWaterMark && (W("maybeReadMore read 0"), e.read(0), n !== t.length);) n = t.length;
                    t.readingMore = !1
                }
                ...
                function k(e) {
                    return function() {
                        var t = e._readableState;
                        W("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && j(e, "data") && (t.flowing = !0, v(e))
                    }
                }
                ...
                function C(e, t) {
                    t.resumeScheduled || (t.resumeScheduled = !0, U.nextTick(S, e, t))
                }

                function S(e, t) {
                    t.reading || (W("resume read 0"), e.read(0)), t.resumeScheduled = !1, t.awaitDrain = 0, e.emit("resume"), v(e), t.flowing && !t.reading && e.read(0)
                }
                ...
                function L(e, t, n) {
                    var r;
                    return e < t.head.data.length ? (r = t.head.data.slice(0, e), t.head.data = t.head.data.slice(e)) : e === t.head.data.length ? r = t.shift() : r = n ? I(e, t) : B(e, t), r
                }
                ...
                function I(e, t) {
                    ...
                    for (e -= i.length; r = r.next;) {
                        ...
                        if (i += s === a.length ? a : a.slice(0, e), e -= s, 0 === e) {
                            s === a.length ? (++o, t.head = r.next ? r.next : t.tail = null) : (t.head = r, r.data = a.slice(s));
                            break
                        }++o
                    }
                    return t.length -= o, i
                ...
                function B(e, t) {
                    ...
                    for (o.data.copy(r), e -= o.data.length; o = o.next;) {
                        ...
                        if (a.copy(r, r.length - e, 0, s), e -= s, 0 === e) {
                            s === a.length ? (++i, t.head = o.next ? o.next : t.tail = null) : (t.head = o, o.data = a.slice(s));
                            break
                        }++i
                    }
                    return t.length -= i, r
                ...
                function T(e) {
                    ...
                    t.endEmitted || (t.ended = !0, U.nextTick(R, t, e))
                }
                ...
                }), l.prototype.destroy = V.destroy, l.prototype._undestroy = V.undestroy, l.prototype._destroy = function(e, t) {
                    this.push(null), t(e)
                ...
                l.prototype.read = function(e) {
                    ...
                    var t = this._readableState,
                        r = e;
                    if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return W("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? T(this) : _(this), null;
                    if (e = m(e, t), 0 === e && t.ended) return 0 === t.length && T(this), null;
                    var o = t.needReadable;
                    W("need readable", o), (0 === t.length || t.length - e < t.highWaterMark) && (o = !0, W("length less than watermark", o)), t.ended || t.reading ? (o = !1, W("reading or ended", o)) : o && (W("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, !t.reading && (e = m(r, t)));
                    var i;
                    return i = 0 < e ? E(e, t) : null, null === i ? (t.needReadable = !0, e = 0) : t.length -= e, 0 === t.length && (!t.ended && (t.needReadable = !0), r !== e && t.ended && T(this)), null !== i && this.emit("data", i), i
                }, l.prototype._read = function() {
                    this.emit("error", new Error("_read() is not implemented"))
                }, l.prototype.pipe = function(e, t) {
                    function n(e, t) {
                        W("onunpipe"), e === p && t && !1 === t.hasUnpiped && (t.hasUnpiped = !0, i())
                    }
                    ...
                    function i() {
                        W("cleanup"), e.removeListener("close", l), e.removeListener("finish", c), e.removeListener("drain", g), e.removeListener("error", d), e.removeListener("unpipe", n), p.removeListener("end", o), p.removeListener("end", u), p.removeListener("data", a), _ = !0, f.awaitDrain && (!e._writableState || e._writableState.needDrain) && g()
                    }

                    function a(t) {
                        W("ondata"), b = !1;
                        var n = e.write(t);
                        !1 !== n || b || ((1 === f.pipesCount && f.pipes === e || 1 < f.pipesCount && -1 !== A(f.pipes, e)) && !_ && (W("false write response, pause", p._readableState.awaitDrain), p._readableState.awaitDrain++, b = !0), p.pause())
                    }

                    function d(t) {
                        W("onerror", t), u(), e.removeListener("error", d), 0 === j(e, "error") && e.emit("error", t)
                    }
                    ...
                    function c() {
                        W("onfinish"), e.removeListener("close", l), u()
                    }
                    ...
                    var h = (!t || !1 !== t.end) && e !== r.stdout && e !== r.stderr,
                        m = h ? o : u;
                    f.endEmitted ? U.nextTick(m) : p.once("end", m), e.on("unpipe", n);
                    var g = k(p);
                    e.on("drain", g);
                    var _ = !1,
                        b = !1;
                    return p.on("data", a), s(e, "error", d), e.once("close", l), e.once("finish", c), e.emit("pipe", p), f.flowing || (W("pipe resume"), p.resume()), e
                    ...
                    if ("data" === e) !1 !== this._readableState.flowing && this.resume();
                        ...
                        r.endEmitted || r.readableListening || (r.readableListening = r.needReadable = !0, r.emittedReadable = !1, r.reading ? r.length && _(this) : U.nextTick(x, this))
                    }
                    return n
                }, l.prototype.addListener = l.prototype.on, l.prototype.resume = function() {
                    var e = this._readableState;
                    return e.flowing || (W("resume"), e.flowing = !0, C(this, e)), this
                    ...
                    for (var i = 0; i < K.length; i++) e.on(K[i], this.emit.bind(this, K[i]));
        ...
        21: [function(e, t) {
            ...
            function r(e) {
                return this instanceof r ? void(a.call(this, e), this._transformState = {
            ...
            var a = e("./_stream_duplex"),
                s = e("core-util-is");
            s.inherits = e("inherits"), s.inherits(r, a), r.prototype.push = function(e, t) {
        ...
        22: [function(e, t) {
            (function(r, o, i) {
                ...
                function d(e) {
                    return M.isBuffer(e) || e instanceof O
                }
                ...
                function c(t, r) {
                    ...
                    this.highWaterMark = i || 0 === i ? i : o && (s || 0 === s) ? s : d, this.highWaterMark = n(this.highWaterMark), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
                ...
                function u(t) {
                    return R = R || e("./_stream_duplex"), N.call(u, this) || this instanceof R ? void(this._writableState = new c(t, this), this.writable = !0, t && ("function" == typeof t.write && (this._write = t.write), "function" == typeof t.writev && (this._writev = t.writev), "function" == typeof t.destroy && (this._destroy = t.destroy), "function" == typeof t.final && (this._final = t.final)), P.call(this)) : new u(t)
                }

                function p(e, t) {
                    var n = new Error("write after end");
                    e.emit("error", n), B.nextTick(t, n)
                }

                function f(e, t, n, r) {
                    var o = !0,
                        i = !1;
                    return null === n ? i = new TypeError("May not write null values to stream") : "string" != typeof n && void 0 !== n && !t.objectMode && (i = new TypeError("Invalid non-string/buffer chunk")), i && (e.emit("error", i), B.nextTick(r, i), o = !1), o
                }
                ...
                function _(e, t, n, r, o) {
                    --t.pendingcb, n ? (B.nextTick(o, r), B.nextTick(E, e, t), e._writableState.errorEmitted = !0, e.emit("error", r)) : (o(r), e._writableState.errorEmitted = !0, e.emit("error", r), E(e, t))
                }
                ...
                function y(e, t) {
                    ...
                    if (b(n), t) _(e, n, r, t, o);
                        ...
                        var i = C(n);
                        i || n.corked || n.bufferProcessing || !n.bufferedRequest || x(e, n), r ? T(w, e, n, i, o) : w(e, n, i, o)
                    }
                }
                ...
                function x(e, t) {
                    ...
                    if (e._writev && n && n.next) {
                        ...
                        i.entry = n;
                        for (var s = 0, d = !0; n;) o[s] = n, n.isBuf || (d = !1), n = n.next, s += 1;
                        o.allBuffers = d, g(e, t, !0, t.length, o, "", i.finish), t.pendingcb++, t.lastBufferedRequest = null, i.next ? (t.corkedRequestsFree = i.next, i.next = null) : t.corkedRequestsFree = new a(t), t.bufferedRequestCount = 0
                    } else {
                        for (; n;) {
                            var l = n.chunk,
                                c = n.encoding,
                ...
                function v(e, t) {
                    t.prefinished || t.finalCalled || ("function" == typeof e._final ? (t.pendingcb++, t.finalCalled = !0, B.nextTick(S, e, t)) : (t.prefinished = !0, e.emit("prefinish")))
                }
                ...
                function L(e, t, n) {
                    t.ending = !0, E(e, t), n && (t.finished ? B.nextTick(n) : e.once("finish", n)), t.ended = !0, e.writable = !1
                }
                ...
                t.exports = u;
                var T = !r.browser && -1 < ["v0.10", "v0.9."].indexOf(r.version.slice(0, 5)) ? i : B.nextTick,
                    R;
                u.WritableState = c;
                ...
                A.inherits(u, P), c.prototype.getBuffer = function() {
                ...
                "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (N = Function.prototype[Symbol.hasInstance], Object.defineProperty(u, Symbol.hasInstance, {
                    value: function(e) {
                        return !!N.call(this, e) || !(this !== u) && e && e._writableState instanceof c
                    }
                })) : N = function(e) {
                    ...
                    var r = this._writableState,
                        o = !1,
                        i = !r.objectMode && d(e);
                    return i && !M.isBuffer(e) && (e = s(e)), "function" == typeof t && (n = t, t = null), i ? t = "buffer" : !t && (t = r.defaultEncoding), "function" != typeof n && (n = l), r.ended ? p(this, n) : (i || f(this, r, e, n)) && (r.pendingcb++, o = m(this, r, i, e, t, n)), o
        ...
        24: [function(e, t) {
            ...
            t.exports = {
                destroy: function(e, t) {
                    ...
                    return i || a ? (t ? t(e) : e && (!this._writableState || !this._writableState.errorEmitted) && r.nextTick(n, this, e), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(e || null, function(e) {
        ...
        27: [function(e, t) {
            (function(n) {
                function r(e) {
                    ...
                    var s = this;
                    if (!(s instanceof r)) return new r(e);
                    if (a.call(s), e || (e = {}), !e.peerId) throw new Error("Option `peerId` is required");
                    ...
                    var l = !1 !== s._wrtc && (!!s._wrtc || u.WEBRTC_SUPPORT);
                    s._trackers = d.map(function(e) {
                        var n = f.parse(e).protocol;
                        return ("http:" === n || "https:" === n) && "function" == typeof m ? new m(s, e) : "udp:" === n && "function" == typeof g ? new g(s, e) : ("ws:" === n || "wss:" === n) && l ? "ws:" === n && "undefined" != typeof window && "https:" === window.location.protocol ? (t(new Error("Unsupported tracker protocol: " + e)), null) : new _(s, e) : (t(new Error("Unsupported tracker protocol: " + e)), null)
                    }).filter(Boolean)
                }
                t.exports = r;
                var o = e("safe-buffer").Buffer,
                ...
                d(r, a), r.scrape = function(e, t) {
                    ...
                    var a = Array.isArray(e.infoHash) ? e.infoHash.length : 1,
                        d = {};
                    return i.on("scrape", function(e) {
                        if (a -= 1, d[e.infoHash] = e, 0 === a) {
                            i.destroy();
                            var n = Object.keys(d);
                    ...
                    var t = this;
                    return e || (e = {}), null == e.numwant && (e.numwant = h.DEFAULT_ANNOUNCE_PEERS), null == e.uploaded && (e.uploaded = 0), null == e.downloaded && (e.downloaded = 0), t._getAnnounceOpts && (e = s(e, t._getAnnounceOpts())), e
                }
            }).call(this, e("_process"))
        }, {
            "./lib/client/http-tracker": 45,
            "./lib/client/udp-tracker": 45,
            "./lib/client/websocket-tracker": 29,
            "./lib/common": 30,
            _process: 138,
            debug: 31,
            events: 48,
        ...
        29: [function(e, r) {
            ...
            var a = e("debug")("bittorrent-tracker:websocket-tracker"),
                ...
                c = e("simple-peer"),
                u = e("randombytes"),
                p = e("simple-websocket"),
                f = e("../common"),
                h = e("./tracker"),
                m = {};
            o._socketPool = m;
            l(o, h), o.prototype.DEFAULT_ANNOUNCE_INTERVAL = 30000, o.prototype.announce = function(e) {
                var t = this;
                ...
                function t() {
                    s && (clearTimeout(s), s = null), a.removeListener("data", t), a.destroy(), a = null
                }
                var n = this;
                ...
                var a = m[n.announceUrl];
                if (delete m[n.announceUrl], a.on("error", i), a.once("close", e), !n.expectingResponse) return t();
                var s = setTimeout(t, f.DESTROY_TIMEOUT);
                a.once("data", t)
                ...
                e.destroyed = !1, e.peers || (e.peers = {}), e._onSocketConnectBound = function() {
                    ...
                    e._onSocketClose()
                }, e.socket = m[e.announceUrl], e.socket ? m[e.announceUrl].consumers += 1 : (e.socket = m[e.announceUrl] = new p(e.announceUrl), e.socket.consumers = 1, e.socket.once("connect", e._onSocketConnectBound)), e.socket.on("data", e._onSocketDataBound), e.socket.once("close", e._onSocketCloseBound), e.socket.once("error", e._onSocketErrorBound)
                ...
                var t = this;
                if (e.info_hash !== t.client._infoHashBinary) return void a("ignoring websocket data from %s for %s (looking for %s: reused socket)", t.announceUrl, f.binaryToHex(e.info_hash), t.client.infoHash);
                if (!(e.peer_id && e.peer_id === t.client._peerIdBinary)) {
                    ...
                    if (e.offer && e.peer_id && (a("creating peer (from remote offer)"), d = t._createPeer(), d.id = f.binaryToHex(e.peer_id), d.once("signal", function(n) {
                        ...
                        var l = f.binaryToHex(e.offer_id);
                        d = t.peers[l], d ? (d.id = f.binaryToHex(e.peer_id), d.signal(e.answer), t.client.emit("peer", d), clearTimeout(d.trackerTimeout), d.trackerTimeout = null, delete t.peers[l]) : a("got unexpected answer: " + JSON.stringify(e.answer))
                    }
                }
                ...
                var e = this,
                    r = n(Math.random() * 30000) + d(t(2, e.retries) * 15000, 1800000);
                e.reconnecting = !0, clearTimeout(e.reconnectTimer), e.reconnectTimer = setTimeout(function() {
                    e.retries++, e._openSocket()
                }, r), e.reconnectTimer.unref && e.reconnectTimer.unref(), a("reconnecting socket in %s ms", r)
        ...
        35: [function(e, t) {
            (function(n) {
                function r(e, t) {
                    return this instanceof r ? void(i.call(this), !t && (t = {}), "object" == typeof e && (t = e, e = t.size), this.size = e || 512, this._zeroPadding = !t.nopad && a(t.zeroPadding, !0), this._buffered = [], this._bufferedBytes = 0) : new r(e, t)
                }
                var o = e("inherits"),
        ...
        47: [function(e, n, r) {
            ...
            function l(e, t, n) {
                ...
                if (Y(e, ArrayBuffer) || e && Y(e.buffer, ArrayBuffer)) return m(e, t, n);
            ...
            function u(e, t, n) {
                return c(e), 0 >= e ? a(e) : void 0 === t ? a(e) : "string" == typeof n ? a(e).fill(t, n) : a(e).fill(t)
            }

            function p(e) {
                return c(e), a(0 > e ? 0 : 0 | _(e))
            }
            ...
            function h(e) {
                for (var t = 0 > e.length ? 0 : 0 | _(e.length), n = a(t), r = 0; r < t; r += 1) n[r] = 255 & e[r];
                return n
            }
            ...
            function g(e) {
                ...
                return void 0 === e.length ? "Buffer" === e.type && Array.isArray(e.data) ? h(e.data) : void 0 : "number" != typeof e.length || X(e.length) ? a(0) : h(e)
            }
            ...
            function k(e, t, n, r, o) {
                ...
                if ("string" == typeof t && (t = s.from(t, r)), s.isBuffer(t)) return 0 === t.length ? -1 : x(e, t, n, r, o);
                if ("number" == typeof t) return t &= 255, "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : x(e, [t], n, r, o);
            ...
            function x(e, t, n, r, o) {
                ...
                if (o) {
                    var u = -1;
                    for (c = n; c < d; c++)
                        if (a(e, c) !== a(t, -1 === u ? 0 : c - u)) - 1 !== u && (c -= c - u), u = -1;
            ...
            function T(e, t, n) {
                ...
                for (var r = [], o = t; o < n;) {
                    ...
                    if (o + l <= n) {
                        var c, u, p, f;
                        1 === l ? 128 > a && (s = a) : 2 === l ? (c = e[o + 1], 128 == (192 & c) && (f = (31 & a) << 6 | 63 & c, 127 < f && (s = f))) : 3 === l ? (c = e[o + 1], u = e[o + 2], 128 == (192 & c) && 128 == (192 & u) && (f = (15 & a) << 12 | (63 & c) << 6 | 63 & u, 2047 < f && (55296 > f || 57343 < f) && (s = f))) : 4 === l ? (c = e[o + 1], u = e[o + 2], p = e[o + 3], 128 == (192 & c) && 128 == (192 & u) && 128 == (192 & p) && (f = (15 & a) << 18 | (63 & c) << 12 | (63 & u) << 6 | 63 & p, 65535 < f && 1114112 > f && (s = f))) : void 0
                    }
                    null === s ? (s = 65533, l = 1) : 65535 < s && (s -= 65536, r.push(55296 | 1023 & s >>> 10), s = 56320 | 1023 & s), r.push(s), o += l
                }
                return R(r)
            }
            ...
            function R(e) {
                ...
                for (var n = "", r = 0; r < t;) n += o.apply(String, e.slice(r, r += 4096));
                return n
            }
            ...
            function P(e, t, n) {
                ...
                for (var o = "", a = t; a < n; ++a) o += D(e[a]);
                return o
            }

            function M(e, t, n) {
                for (var r = e.slice(t, n), a = "", s = 0; s < r.length; s += 2) a += o(r[s] + 256 * r[s + 1]);
                return a
            }
            ...
            function F(e, t, n, r, o) {
                return t = +t, n >>>= 0, o || N(e, t, n, 4, 34028234663852886e22, -34028234663852886e22), J.write(e, t, n, r, 23, 4), n + 4
            }

            function H(e, t, n, r, o) {
                return t = +t, n >>>= 0, o || N(e, t, n, 8, 17976931348623157e292, -17976931348623157e292), J.write(e, t, n, r, 52, 8), n + 8
            }
            ...
            function W(e, t) {
                t = t || 1 / 0;
                for (var n = e.length, r = null, o = [], a = 0, s; a < n; ++a) {
                    if (s = e.charCodeAt(a), 55295 < s && 57344 > s) {
                        if (!r) {
                            if (56319 < s) {
                    ...
                    if (r = null, 128 > s) {
                        ...
                        if (0 > (t -= 2)) break;
                        o.push(192 | s >> 6, 128 | 63 & s)
                    } else if (65536 > s) {
                        if (0 > (t -= 3)) break;
                        o.push(224 | s >> 12, 128 | 63 & s >> 6, 128 | 63 & s)
                    } else if (1114112 > s) {
                        if (0 > (t -= 4)) break;
                        o.push(240 | s >> 18, 128 | 63 & s >> 12, 128 | 63 & s >> 6, 128 | 63 & s)
            ...
            function V(e, t) {
                for (var n = [], r = 0, o, a, s; r < e.length && !(0 > (t -= 2)); ++r) o = e.charCodeAt(r), a = o >> 8, s = o % 256, n.push(s), n.push(a);
                return n
            }
            ...
            r.kMaxLength = 2147483647, s.TYPED_ARRAY_SUPPORT = function() {
                ...
                if (e === t) return 0;
                for (var n = e.length, r = t.length, o = 0, l = d(n, r); o < l; ++o)
                    if (e[o] !== t[o]) {
                        n = e[o], r = t[o];
                        break
                    }
                ...
                for (var a = o - r, l = n - t, c = d(a, l), u = this.slice(r, o), p = e.slice(t, n), f = 0; f < c; ++f)
                    if (u[f] !== p[f]) {
                        a = u[f], l = p[f];
                        break
                    }
            ...
            s.prototype.slice = function(e, t) {
            ...
            }, s.prototype.readIntLE = function(e, n, r) {
                e >>>= 0, n >>>= 0, r || O(e, n, this.length);
                for (var o = this[e], a = 1, s = 0; ++s < n && (a *= 256);) o += this[e + s] * a;
                return a *= 128, o >= a && (o -= t(2, 8 * n)), o
            }, s.prototype.readIntBE = function(e, n, r) {
                e >>>= 0, n >>>= 0, r || O(e, n, this.length);
                for (var o = n, a = 1, s = this[e + --o]; 0 < o && (a *= 256);) s += this[e + --o] * a;
                return a *= 128, s >= a && (s -= t(2, 8 * n)), s
            ...
            }, s.prototype.writeUIntLE = function(e, n, r, o) {
                if (e = +e, n >>>= 0, r >>>= 0, !o) {
                    var a = t(2, 8 * r) - 1;
                    j(this, e, n, r, a, 0)
                }
                var s = 1,
                    d = 0;
                for (this[n] = 255 & e; ++d < r && (s *= 256);) this[n + d] = 255 & e / s;
                return n + r
            }, s.prototype.writeUIntBE = function(e, n, r, o) {
                if (e = +e, n >>>= 0, r >>>= 0, !o) {
                    var a = t(2, 8 * r) - 1;
                    j(this, e, n, r, a, 0)
                }
                var s = r - 1,
                    d = 1;
                for (this[n + s] = 255 & e; 0 <= --s && (d *= 256);) this[n + s] = 255 & e / d;
                return n + r
            }, s.prototype.writeUInt8 = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 1, 255, 0), this[t] = 255 & e, t + 1
            }, s.prototype.writeUInt16LE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 2, 65535, 0), this[t] = 255 & e, this[t + 1] = e >>> 8, t + 2
            }, s.prototype.writeUInt16BE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 2, 65535, 0), this[t] = e >>> 8, this[t + 1] = 255 & e, t + 2
            }, s.prototype.writeUInt32LE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 4, 4294967295, 0), this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e, t + 4
            }, s.prototype.writeUInt32BE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 4, 4294967295, 0), this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e, t + 4
            }, s.prototype.writeIntLE = function(e, n, r, o) {
                if (e = +e, n >>>= 0, !o) {
                    var a = t(2, 8 * r - 1);
                    j(this, e, n, r, a - 1, -a)
                }
                var s = 0,
                    d = 1,
                    l = 0;
                for (this[n] = 255 & e; ++s < r && (d *= 256);) 0 > e && 0 === l && 0 !== this[n + s - 1] && (l = 1), this[n + s] = 255 & (e / d >> 0) - l;
                return n + r
            }, s.prototype.writeIntBE = function(e, n, r, o) {
                if (e = +e, n >>>= 0, !o) {
                    var a = t(2, 8 * r - 1);
                    j(this, e, n, r, a - 1, -a)
                }
                var s = r - 1,
                    d = 1,
                    l = 0;
                for (this[n + s] = 255 & e; 0 <= --s && (d *= 256);) 0 > e && 0 === l && 0 !== this[n + s + 1] && (l = 1), this[n + s] = 255 & (e / d >> 0) - l;
                return n + r
            }, s.prototype.writeInt8 = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 1, 127, -128), 0 > e && (e = 255 + e + 1), this[t] = 255 & e, t + 1
            }, s.prototype.writeInt16LE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 2, 32767, -32768), this[t] = 255 & e, this[t + 1] = e >>> 8, t + 2
            }, s.prototype.writeInt16BE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 2, 32767, -32768), this[t] = e >>> 8, this[t + 1] = 255 & e, t + 2
            }, s.prototype.writeInt32LE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 4, 2147483647, -2147483648), this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24, t + 4
            }, s.prototype.writeInt32BE = function(e, t, n) {
                return e = +e, t >>>= 0, n || j(this, e, t, 4, 2147483647, -2147483648), 0 > e && (e = 4294967295 + e + 1), this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e, t + 4
        ...
        48: [function(e, t) {
            ...
            function a(e, t, n) {
                if (t) e.call(n);
                    ...
                    for (var r = e.length, o = _(e, r), a = 0; a < r; ++a) o[a].call(n)
            }

            function s(e, t, n, r) {
                if (t) e.call(n, r);
                else
                    for (var o = e.length, a = _(e, o), s = 0; s < o; ++s) a[s].call(n, r)
            }

            function d(e, t, n, r, o) {
                if (t) e.call(n, r, o);
                else
                    for (var a = e.length, s = _(e, a), d = 0; d < a; ++d) s[d].call(n, r, o)
            }

            function l(e, t, n, r, o, a) {
                if (t) e.call(n, r, o, a);
                else
                    for (var s = e.length, d = _(e, s), l = 0; l < s; ++l) d[l].call(n, r, o, a)
            }

            function c(e, t, n, r) {
                if (t) e.apply(n, r);
                else
                    for (var o = e.length, a = _(e, o), s = 0; s < o; ++s) a[s].apply(n, r)
            }

            function u(e, t, n, o) {
                var i, a, s;
                if ("function" != typeof n) throw new TypeError("\"listener\" argument must be a function");
                if (a = e._events, a ? (a.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), a = e._events), s = a[t]) : (a = e._events = y(null), e._eventsCount = 0), !s) s = a[t] = n, ++e._eventsCount;
                else if ("function" == typeof s ? s = a[t] = o ? [n, s] : [s, n] : o ? s.unshift(n) : s.push(n), !s.warned && (i = r(e), i && 0 < i && s.length > i)) {
                    s.warned = !0;
            ...
            function h(e, t, n) {
                ...
                if (!r) return [];
                var o = r[t];
                return o ? "function" == typeof o ? n ? [o.listener || o] : [o] : n ? b(o) : _(o, o.length) : []
            }
            ...
            C ? Object.defineProperty(n, "defaultMaxListeners", {
                enumerable: !0,
                get: function() {
                    return x
                },
                ...
                switch (o = arguments.length, o) {
                    case 1:
                        ...
                        break;
                    case 2:
                        s(r, m, this, arguments[1]);
                        break;
                    case 3:
                        d(r, m, this, arguments[1], arguments[2]);
                        break;
                    case 4:
                ...
                if (n === t || n.listener === t) 0 == --this._eventsCount ? this._events = y(null) : (delete r[e], r.removeListener && this.emit("removeListener", e, n.listener || t));
                    ...
                    if (0 > o) return this;
                    0 === o ? n.shift() : g(n, o), 1 === n.length && (r[e] = n[0]), r.removeListener && this.emit("removeListener", e, s || t)
                }
                return this
        ...
        51: [function(e, t) {
            (function(n) {
                ...
                t.exports = function(e, t, i) {
                    ...
                    var a = o(e);
                    return 0 === e ? a : void 0 === t ? r(a, 0) : ("string" != typeof i && (i = void 0), r(a, t, i))
                }
            }).call(this, e("buffer").Buffer)
        }, {
            buffer: 47,
            "buffer-alloc-unsafe": 50,
            "buffer-fill": 52
        }],
        52: [function(e, t) {
            (function(e) {
                ...
                function o(e, t, n, r) {
                    ...
                    for (var o = n, i = t.length; o <= r - i;) t.copy(e, o), o += i;
                ...
                t.exports = function(t, a, s, d, l) {
                    if (i) return t.fill(a, s, d, l);
                    if ("number" == typeof a) return r(t, a, s, d);
                    if ("string" == typeof a) {
                        if ("string" == typeof s ? (l = s, s = 0, d = t.length) : "string" == typeof d && (l = d, d = t.length), void 0 !== l && "string" != typeof l) throw new TypeError("encoding must be a string");
                        if ("latin1" === l && (l = "binary"), "string" == typeof l && !e.isEncoding(l)) throw new TypeError("Unknown encoding: " + l);
                        if ("" === a) return r(t, 0, s, d);
                        if (n(a)) return r(t, a.charCodeAt(0), s, d);
                        a = new e(a, l)
                    }
                    return e.isBuffer(a) ? o(t, a, s, d) : r(t, 0, s, d)
                }
            }).call(this, e("buffer").Buffer)
        }, {
            buffer: 47
        ...
        53: [function(e, t) {
            (function(e) {
                function n(e) {
                    return "ArrayBuffer" === i.call(e).slice(8, -1)
                }

                function r(t, n, r) {
                    n >>>= 0;
                    var o = t.byteLength - n;
                    if (0 > o) throw new RangeError("'offset' is out of bounds");
                    if (void 0 === r) r = o;
                    else if (r >>>= 0, r > o) throw new RangeError("'length' is out of bounds");
                    return a ? e.from(t.slice(n, n + r)) : new e(new Uint8Array(t.slice(n, n + r)))
                }

                function o(t, n) {
                    if (("string" != typeof n || "" === n) && (n = "utf8"), !e.isEncoding(n)) throw new TypeError("\"encoding\" must be a valid string encoding");
                    return a ? e.from(t, n) : new e(t, n)
                }
                var i = Object.prototype.toString,
                    a = "function" == typeof e.alloc && "function" == typeof e.allocUnsafe && "function" == typeof e.from;
                t.exports = function(t, i, s) {
                    if ("number" == typeof t) throw new TypeError("\"value\" argument must not be a number");
                    return n(t) ? r(t, i, s) : "string" == typeof t ? o(t, i) : a ? e.from(t) : new e(t)
                }
            }).call(this, e("buffer").Buffer)
        }, {
            buffer: 47
        ...
        57: [function(e, t, n) {
            ...
            "./_stream_duplex": 55,
            "./internal/streams/BufferList": 60,
        ...
        63: [function(e, t, n) {
            ...
            "./lib/_stream_duplex.js": 55,
            "./lib/_stream_passthrough.js": 56,
            "./lib/_stream_readable.js": 57,
            "./lib/_stream_transform.js": 58,
            "./lib/_stream_writable.js": 59,
            dup: 26
        }],
        64: [function(e, t) {
        ...
        65: [function(e, t) {
            t.exports = function(e, t, n) {
                for (var o = 1 / 0, a = 0, s = t.length - 1, d, l, c; a <= s && (d = a + (s - a >> 1), c = t[d] - e, 0 > c ? a = d + 1 : 0 < c ? s = d - 1 : void 0, c = r(c), c < o && (o = c, l = d), t[d] !== e););
                return n ? l : t[l]
            }
        }, {}],
        66: [function(e, t, n) {
            ...
            (function(n, r, o) {
                function i(e, t, r) {
                    function i() {
                        A(e.map(e => t => {
                            const n = {};
                            if (h(e)) n.getStream = _(e), n.length = e.size;
                            else if (o.isBuffer(e)) n.getStream = b(e), n.length = e.length;
                            else if (g(e)) n.getStream = w(e, n), n.length = 0;
                            else {
                                if ("string" == typeof e) {
                                    if ("function" != typeof L.stat) throw new Error("filesystem paths do not work in the browser");
                                    const n = 1 < d || l;
                                    return void s(e, n, t)
                                }
                        ...
                        }), (e, t) => e ? r(e) : void(t = E(t), r(null, t, l)))
                    }
                    ...
                    }), e = e.map(e => h(e) && "string" == typeof e.path && "function" == typeof L.stat ? e.path : e), 1 !== e.length || "string" == typeof e[0] || e[0].name || (e[0].name = t.name);
                    let a = null;
                    e.forEach((t, n) => {
                        if ("string" == typeof t) return;
                        let r = t.fullPath || t.name;
                        r || (r = `Unknown File ${n+1}`, t.unknownName = !0), t.path = r.split("/"), t.path[0] || t.path.shift(), 2 > t.path.length ? a = null : 0 === n && 1 < e.length ? a = t.path[0] : t.path[0] !== a && (a = null)
                    }), e = e.filter(e => {
                        if ("string" == typeof e) return !0;
                        const t = e.path[e.path.length - 1];
                        return c(t) && B.not(t)
                    }), a && e.forEach(e => {
                        const t = (o.isBuffer(e) || g(e)) && !e.path;
                        "string" == typeof e || t || e.path.shift()
                    }), !t.name && a && (t.name = a), t.name || e.some(e => "string" == typeof e ? (t.name = S.basename(e), !0) : e.unknownName ? void 0 : (t.name = e.path[e.path.length - 1], !0)), t.name || (t.name = `Unnamed Torrent ${Date.now()}`);
                    const d = e.reduce((e, t) => e + +("string" == typeof t), 0);
                    let l = 1 === e.length;
                    if (1 === e.length && "string" == typeof e[0]) {
                        if ("function" != typeof L.stat) throw new Error("filesystem paths do not work in the browser");
                        I(e[0], (e, t) => e ? r(e) : void(l = t, i()))
                    } else n.nextTick(() => {
                        i()
                    })
                }
                ...
                function s(e, t, n) {
                    l(e, d, (r, o) => r ? n(r) : void(o = Array.isArray(o) ? E(o) : [o], e = S.normalize(e), t && (e = e.slice(0, e.lastIndexOf(S.sep) + 1)), e[e.length - 1] !== S.sep && (e += S.sep), o.forEach(t => {
                ...
                function l(e, t, n) {
                    L.stat(e, (r, o) => r ? n(r) : void(o.isDirectory() ? L.readdir(e, (r, o) => r ? n(r) : void A(o.filter(c).filter(B.not).map(n => r => {
                        l(S.join(e, n), t, r)
                    }), n)) : o.isFile() && t(e, n)))
                }
                ...
                function u(e, t, n) {
                    ...
                    function s() {
                        m.removeListener("error", a), g.removeListener("data", r), g.removeListener("end", i), g.removeListener("error", a)
                    }

                    function d() {
                        h && 0 == p && (s(), n(null, o.from(l.join(""), "hex"), c))
                    }
                    n = R(n);
                    const l = [];
                    let c = 0;
                    ...
                    m.on("error", a), m.pipe(g).on("data", r).on("end", i).on("error", a)
                }
                ...
                function p(e, n, o) {
                    ...
                    i || ("string" == typeof n.announce ? i = [
                        [n.announce]
                    ] : Array.isArray(n.announce) && (i = n.announce.map(e => [e]))), i || (i = []), r.WEBTORRENT_ANNOUNCE && ("string" == typeof r.WEBTORRENT_ANNOUNCE ? i.push([
                        [r.WEBTORRENT_ANNOUNCE]
                    ]) : Array.isArray(r.WEBTORRENT_ANNOUNCE) && (i = i.concat(r.WEBTORRENT_ANNOUNCE.map(e => [e])))), n.announce === void 0 && n.announceList === void 0 && (i = i.concat(t.exports.announceList)), "string" == typeof n.urlList && (n.urlList = [n.urlList]);
                    const s = {
                        info: {
                            name: n.name
                        },
                    ...
                    0 !== i.length && (s.announce = i[0][0], s["announce-list"] = i), n.comment !== void 0 && (s.comment = n.comment), n.createdBy !== void 0 && (s["created by"] = n.createdBy), n.private !== void 0 && (s.info.private = +n.private), n.sslCert !== void 0 && (s.info["ssl-cert"] = n.sslCert), n.urlList !== void 0 && (s["url-list"] = n.urlList);
                    const d = n.pieceLength || C(e.reduce(f, 0));
                    s.info["piece length"] = d, u(e, d, (t, r, i) => t ? o(t) : void(s.info.pieces = r, e.forEach(e => {
                        delete e.getStream
                    }), n.singleFileTorrent ? s.info.length = i : s.info.files = e, o(null, k.encode(s))))
                }
                ...
                const k = e("bencode"),
                    ...
                    P = e("readable-stream");
                t.exports = function(e, t, n) {
                    "function" == typeof t && ([t, n] = [n, t]), t = t ? Object.assign({}, t) : {}, i(e, t, (e, r, o) => e ? n(e) : void(t.singleFileTorrent = o, p(r, t, n)))
                }, t.exports.parseInput = function(e, t, n) {
                    "function" == typeof t && ([t, n] = [n, t]), t = t ? Object.assign({}, t) : {}, i(e, t, n)
        ...
        70: [function(e, t) {
            t.exports = function(t) {
                ...
                function o(e) {
                    function t(...e) {
                        ...
                        const n = t,
                            i = +new Date,
                            a = i - (r || i);
                        n.diff = a, n.prev = r, n.curr = i, r = i, e[0] = o.coerce(e[0]), "string" != typeof e[0] && e.unshift("%O");
                        let s = 0;
                        e[0] = e[0].replace(/%([a-zA-Z%])/g, (t, r) => {
                            if ("%%" === t) return t;
                            s++;
                            const i = o.formatters[r];
                            if ("function" == typeof i) {
                                const r = e[s];
                                t = i.call(n, r), e.splice(s, 1), s--
                            }
                            return t
                        }), o.formatArgs.call(n, e);
                        const d = n.log || o.log;
                        d.apply(n, e)
                    }
                    let r;
                ...
                return o.debug = o, o.default = o, o.coerce = function(e) {
                    ...
                    const e = [...o.names.map(s), ...o.skips.map(s).map(e => "-" + e)].join(",");
                    return o.enable(""), e
                }, o.enable = function(e) {
                    o.save(e), o.names = [], o.skips = [];
                    let t;
                    ...
                    for (t = 0, n = o.names.length; t < n; t++)
                        if (o.names[t].test(e)) return !0;
                    return !1
                }, o.humanize = e("ms"), Object.keys(t).forEach(e => {
                    o[e] = t[e]
                }), o.instances = [], o.names = [], o.skips = [], o.formatters = {}, o.selectColor = n, o.enable(o.load()), o
            }
        }, {
            ...
            var n = e("once"),
                ...
                a = function(e, t, s) {
                    ...
                    var d = e._writableState,
                        ...
                        _ = function() {
                            return c && !(l && l.ended) ? s.call(e, new Error("premature close")) : u && !(d && d.ended) ? s.call(e, new Error("premature close")) : void 0
                        },
                        b = function() {
                            e.req.on("finish", f)
                        };
                    return o(e) ? (e.on("complete", f), e.on("abort", _), e.req ? b() : e.on("request", b)) : u && !d && (e.on("end", p), e.on("close", p)), i(e) && e.on("exit", m), e.on("end", h), e.on("finish", f), !1 !== t.error && e.on("error", g), e.on("close", _),
                        function() {
                            e.removeListener("complete", f), e.removeListener("abort", _), e.removeListener("request", b), e.req && e.req.removeListener("finish", f), e.removeListener("end", p), e.removeListener("close", p), e.removeListener("finish", f), e.removeListener("exit", m), e.removeListener("end", h), e.removeListener("error", g), e.removeListener("close", _)
                        }
                };
            t.exports = a
        }, {
        ...
        75: [function(e, t, n) {
            ...
            "./_stream_duplex": 73,
            "./internal/streams/BufferList": 78,
            "./internal/streams/destroy": 79,
            "./internal/streams/stream": 80,
            _process: 138,
            "core-util-is": 66,
            dup: 20,
            events: 48,
        ...
        85: [function(e, o, i) {
            i.read = function(n, r, o, a, l) {
                var c = 8 * l - a - 1,
                    ...
                    d = n[r + h],
                    _, b;
                for (h += g, _ = d & (1 << -f) - 1, d >>= -f, f += c; 0 < f; _ = 256 * _ + n[r + h], h += g, f -= 8);
                for (b = _ & (1 << -f) - 1, _ >>= -f, f += a; 0 < f; b = 256 * b + n[r + h], h += g, f -= 8);
                if (0 === _) _ = 1 - p;
                else {
                    if (_ === u) return b ? NaN : (d ? -1 : 1) * (1 / 0);
                    b += t(2, a), _ -= p
                }
                return (d ? -1 : 1) * b * t(2, _ - a)
            }, i.write = function(o, a, l, u, p, f) {
                var h = Math.LN2,
                    g = Math.log,
                    _ = 8 * f - p - 1,
                    b = (1 << _) - 1,
                    y = b >> 1,
                    w = 23 === p ? t(2, -24) - t(2, -77) : 0,
                    k = u ? 0 : f - 1,
                    x = u ? 1 : -1,
                    d = 0 > a || 0 === a && 0 > 1 / a ? 1 : 0,
                    s, C, S;
                for (a = r(a), isNaN(a) || a === 1 / 0 ? (C = isNaN(a) ? 1 : 0, s = b) : (s = n(g(a) / h), 1 > a * (S = t(2, -s)) && (s--, S *= 2), a += 1 <= s + y ? w / S : w * t(2, 1 - y), 2 <= a * S && (s++, S /= 2), s + y >= b ? (C = 0, s = b) : 1 <= s + y ? (C = (a * S - 1) * t(2, p), s += y) : (C = a * t(2, y - 1) * t(2, p), s = 0)); 8 <= p; o[l + k] = 255 & C, k += x, C /= 256, p -= 8);
                for (s = s << p | C, _ += p; 0 < _; o[l + k] = 255 & s, k += x, s /= 256, _ -= 8);
                o[l + k - x] |= 128 * d
            }
        }, {}],
        86: [function(e, t) {
            (function(e) {
                ...
                t.exports = class {
                    ...
                    get(e, t, r) {
                        ...
                        const o = t && t.offset || 0,
                            i = t && t.length && o + t.length,
                            a = this.mem[e];
                        return a ? n(r, null, t ? a.slice(o, i) : a) : void this.store.get(e, t, r)
                    }
                    close(e) {
                        this.store.close(e)
                    }
        ...
        95: [function(e, t) {
            ...
            function r(e, t) {
                var n = this;
                if (a.Writable.call(n), n._wrapper = e, n._elem = e._elem, n._mediaSource = e._mediaSource, n._allStreams = e._streams, n._allStreams.push(n), n._bufferDuration = e._bufferDuration, n._sourceBuffer = null, n._debugBuffers = [], n._openHandler = function() {
                        n._onSourceOpen()
            ...
            }, i(r, a.Writable), r.prototype._onSourceOpen = function() {
                var e = this;
        ...
        98: [function(e, t, n) {
            ...
            "./_stream_duplex": 96,
            "./internal/streams/BufferList": 101,
            "./internal/streams/destroy": 102,
        ...
        104: [function(e, t, n) {
            ...
            "./lib/_stream_duplex.js": 96,
            "./lib/_stream_passthrough.js": 97,
            "./lib/_stream_readable.js": 98,
            "./lib/_stream_transform.js": 99,
            "./lib/_stream_writable.js": 100,
            dup: 26
        }],
        105: [function(e, t) {
            (function(e) {
                function n(e, t) {
                    ...
                    this.chunks = [], this.closed = !1, this.length = +t.length || 1 / 0, this.length !== 1 / 0 && (this.lastChunkLength = this.length % this.chunkLength || this.chunkLength, this.lastChunkIndex = a(this.length / this.chunkLength) - 1)
                }
                ...
                t.exports = n, n.prototype.put = function(e, t, n) {
                    ...
                    var a = t.offset || 0,
                        s = t.length || o.length - a;
                    r(n, null, o.slice(a, s + a))
        ...
        106: [function(e, t, r) {
            ...
            function i(e, t, r) {
                t.writeUInt32BE(n((e.getTime() + 2082844800000) / 1e3), r)
            }

            function a(e, t, r) {
                t.writeUIntBE(n((e.getTime() + 2082844800000) / 1e3), r, 6)
            }

            function s(e, t, r) {
                t.writeUInt16BE(n(e) % 65536, r), t.writeUInt16BE(n(256 * (256 * e)) % 65536, r + 2)
            }

            function l(e, t, r) {
                t[r] = n(e) % 256, t[r + 1] = n(256 * e) % 256
            }
            ...
            function p(e) {
                for (var t = Array(e.length / 4), n = 0; n < t.length; n++) t[n] = m(e, 4 * n);
                return t
            }
            ...
            ["mvhd", "tkhd", "mdhd", "vmhd", "smhd", "stsd", "esds", "stsz", "stco", "co64", "stss", "stts", "ctts", "stsc", "dref", "elst", "hdlr", "mehd", "trex", "mfhd", "tfhd", "tfdt", "trun"].forEach(function(e) {
                r.fullBoxes[e] = !0
            }), r.ftyp = {}, r.ftyp.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(r.ftyp.encodingLength(e));
                var o = e.compatibleBrands || [];
                t.write(e.brand, 0, 4, "ascii"), t.writeUInt32BE(e.brandVersion, 4);
                for (var a = 0; a < o.length; a++) t.write(o[a], 8 + 4 * a, 4, "ascii");
                return r.ftyp.encode.bytes = 8 + 4 * o.length, t
            }, r.ftyp.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.toString("ascii", 0, 4), r = e.readUInt32BE(4), o = [], a = 8; a < e.length; a += 4) o.push(e.toString("ascii", a, a + 4));
                return {
                    brand: n,
                    brandVersion: r,
                    compatibleBrands: o
                }
            }, r.ftyp.encodingLength = function(e) {
                return 8 + 4 * (e.compatibleBrands || []).length
            }, r.mvhd = {}, r.mvhd.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(96), i(e.ctime || new Date, t, 0), i(e.mtime || new Date, t, 4), t.writeUInt32BE(e.timeScale || 0, 8), t.writeUInt32BE(e.duration || 0, 12), s(e.preferredRate || 0, t, 16), l(e.preferredVolume || 0, t, 20), o(t, 22, 32), c(e.matrix, t, 32), t.writeUInt32BE(e.previewTime || 0, 68), t.writeUInt32BE(e.previewDuration || 0, 72), t.writeUInt32BE(e.posterTime || 0, 76), t.writeUInt32BE(e.selectionTime || 0, 80), t.writeUInt32BE(e.selectionDuration || 0, 84), t.writeUInt32BE(e.currentTime || 0, 88), t.writeUInt32BE(e.nextTrackId || 0, 92), r.mvhd.encode.bytes = 96, t
            }, r.mvhd.decode = function(e, t) {
                return e = e.slice(t), {
                    ctime: h(e, 0),
                    mtime: h(e, 4),
            ...
            }, r.mvhd.encodingLength = function() {
                return 96
            }, r.tkhd = {}, r.tkhd.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(80), i(e.ctime || new Date, t, 0), i(e.mtime || new Date, t, 4), t.writeUInt32BE(e.trackId || 0, 8), o(t, 12, 16), t.writeUInt32BE(e.duration || 0, 16), o(t, 20, 28), t.writeUInt16BE(e.layer || 0, 28), t.writeUInt16BE(e.alternateGroup || 0, 30), t.writeUInt16BE(e.volume || 0, 32), c(e.matrix, t, 36), t.writeUInt32BE(e.trackWidth || 0, 72), t.writeUInt32BE(e.trackHeight || 0, 76), r.tkhd.encode.bytes = 80, t
            }, r.tkhd.decode = function(e, t) {
                return e = e.slice(t), {
                    ctime: h(e, 0),
                    mtime: h(e, 4),
            ...
            }, r.tkhd.encodingLength = function() {
                return 80
            }, r.mdhd = {}, r.mdhd.encode = function(e, t, n) {
                return 1 === e.version ? (t = t ? t.slice(n) : w(32), a(e.ctime || new Date, t, 0), a(e.mtime || new Date, t, 8), t.writeUInt32BE(e.timeScale || 0, 16), t.writeUIntBE(e.duration || 0, 20, 6), t.writeUInt16BE(e.language || 0, 28), t.writeUInt16BE(e.quality || 0, 30), r.mdhd.encode.bytes = 32, t) : (t = t ? t.slice(n) : w(20), i(e.ctime || new Date, t, 0), i(e.mtime || new Date, t, 4), t.writeUInt32BE(e.timeScale || 0, 8), t.writeUInt32BE(e.duration || 0, 12), t.writeUInt16BE(e.language || 0, 16), t.writeUInt16BE(e.quality || 0, 18), r.mdhd.encode.bytes = 20, t)
            }, r.mdhd.decode = function(e, t, n) {
                e = e.slice(t);
                return 20 != n - t ? {
                    ctime: f(e, 0),
                    mtime: f(e, 8),
            ...
            }, r.mdhd.encodingLength = function(e) {
                return 1 === e.version ? 32 : 20
            }, r.vmhd = {}, r.vmhd.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(8), t.writeUInt16BE(e.graphicsMode || 0, 0);
                var o = e.opcolor || [0, 0, 0];
                return t.writeUInt16BE(o[0], 2), t.writeUInt16BE(o[1], 4), t.writeUInt16BE(o[2], 6), r.vmhd.encode.bytes = 8, t
            }, r.vmhd.decode = function(e, t) {
                return e = e.slice(t), {
                    graphicsMode: e.readUInt16BE(0),
                    opcolor: [e.readUInt16BE(2), e.readUInt16BE(4), e.readUInt16BE(6)]
                }
            }, r.vmhd.encodingLength = function() {
                return 8
            }, r.smhd = {}, r.smhd.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(4), t.writeUInt16BE(e.balance || 0, 0), o(t, 2, 4), r.smhd.encode.bytes = 4, t
            }, r.smhd.decode = function(e, t) {
                return e = e.slice(t), {
                    balance: e.readUInt16BE(0)
                }
            }, r.smhd.encodingLength = function() {
                return 4
            }, r.stsd = {}, r.stsd.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(r.stsd.encodingLength(e));
                var o = e.entries || [];
                t.writeUInt32BE(o.length, 0);
                for (var a = 4, s = 0, d; s < o.length; s++) d = o[s], b.encode(d, t, a), a += b.encode.bytes;
                return r.stsd.encode.bytes = a, t
            }, r.stsd.decode = function(e, t, n) {
                e = e.slice(t);
                for (var r = e.readUInt32BE(0), o = Array(r), a = 4, s = 0, d; s < r; s++) d = b.decode(e, a, n), o[s] = d, a += d.length;
                return {
                    entries: o
                }
            }, r.stsd.encodingLength = function(e) {
                var t = 4;
                if (!e.entries) return t;
                for (var n = 0; n < e.entries.length; n++) t += b.encodingLength(e.entries[n]);
                return t
            }, r.avc1 = r.VisualSampleEntry = {}, r.VisualSampleEntry.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(r.VisualSampleEntry.encodingLength(e)), o(t, 0, 6), t.writeUInt16BE(e.dataReferenceIndex || 0, 6), o(t, 8, 24), t.writeUInt16BE(e.width || 0, 24), t.writeUInt16BE(e.height || 0, 26), t.writeUInt32BE(e.hResolution || 4718592, 28), t.writeUInt32BE(e.vResolution || 4718592, 32), o(t, 36, 40), t.writeUInt16BE(e.frameCount || 1, 40);
                var i = e.compressorName || "",
                    a = d(i.length, 31);
                t.writeUInt8(a, 42), t.write(i, 43, a, "utf8"), t.writeUInt16BE(e.depth || 24, 74), t.writeInt16BE(-1, 76);
                var s = 78,
                    l = e.children || [];
                l.forEach(function(e) {
                    b.encode(e, t, s), s += b.encode.bytes
                }), r.VisualSampleEntry.encode.bytes = s
            }, r.VisualSampleEntry.decode = function(e, t, n) {
                e = e.slice(t);
                for (var r = n - t, o = d(e.readUInt8(42), 31), i = {
                    ...
                    var s = b.decode(e, a, r);
                    i.children.push(s), i[s.type] = s, a += s.length
                }
                return i
            }, r.VisualSampleEntry.encodingLength = function(e) {
                var t = 78,
                    n = e.children || [];
                return n.forEach(function(e) {
                    t += b.encodingLength(e)
                }), t
            }, r.avcC = {}, r.avcC.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(e.buffer.length), e.buffer.copy(t), r.avcC.encode.bytes = e.buffer.length
            }, r.avcC.decode = function(e, t, n) {
                return e = e.slice(t, n), {
                    mimeCodec: e.toString("hex", 1, 4),
                    buffer: k(e)
                }
            }, r.avcC.encodingLength = function(e) {
                return e.buffer.length
            }, r.mp4a = r.AudioSampleEntry = {}, r.AudioSampleEntry.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(r.AudioSampleEntry.encodingLength(e)), o(t, 0, 6), t.writeUInt16BE(e.dataReferenceIndex || 0, 6), o(t, 8, 16), t.writeUInt16BE(e.channelCount || 2, 16), t.writeUInt16BE(e.sampleSize || 16, 18), o(t, 20, 24), t.writeUInt32BE(e.sampleRate || 0, 24);
                var i = 28,
                    a = e.children || [];
                a.forEach(function(e) {
                    b.encode(e, t, i), i += b.encode.bytes
                }), r.AudioSampleEntry.encode.bytes = i
            }, r.AudioSampleEntry.decode = function(e, t, n) {
                e = e.slice(t, n);
                for (var r = n - t, o = {
                        dataReferenceIndex: e.readUInt16BE(6),
                ...
                return o
            }, r.AudioSampleEntry.encodingLength = function(e) {
                var t = 28,
                    n = e.children || [];
                return n.forEach(function(e) {
                    t += b.encodingLength(e)
                }), t
            }, r.esds = {}, r.esds.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(e.buffer.length), e.buffer.copy(t, 0), r.esds.encode.bytes = e.buffer.length
            }, r.esds.decode = function(e, t, n) {
                e = e.slice(t, n);
                var r = y.Descriptor.decode(e, 0, e.length),
                    o = "ESDescriptor" === r.tagName ? r : {},
                    i = o.DecoderConfigDescriptor || {},
                    a = i.oti || 0,
                    s = i.DecoderSpecificInfo,
                    d = s ? (248 & s.buffer.readUInt8(0)) >> 3 : 0,
                    l = null;
                return a && (l = a.toString(16), d && (l += "." + d)), {
                    mimeCodec: l,
                    buffer: k(e.slice(0))
                }
            }, r.esds.encodingLength = function(e) {
                return e.buffer.length
            }, r.stsz = {}, r.stsz.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.stsz.encodingLength(e)), t.writeUInt32BE(0, 0), t.writeUInt32BE(o.length, 4);
                for (var a = 0; a < o.length; a++) t.writeUInt32BE(o[a], 4 * a + 8);
                return r.stsz.encode.bytes = 8 + 4 * o.length, t
            }, r.stsz.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = e.readUInt32BE(4), o = Array(r), a = 0; a < r; a++) o[a] = 0 === n ? e.readUInt32BE(4 * a + 8) : n;
                return {
                    entries: o
                }
            }, r.stsz.encodingLength = function(e) {
                return 8 + 4 * e.entries.length
            }, r.stss = r.stco = {}, r.stco.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.stco.encodingLength(e)), t.writeUInt32BE(o.length, 0);
                for (var a = 0; a < o.length; a++) t.writeUInt32BE(o[a], 4 * a + 4);
                return r.stco.encode.bytes = 4 + 4 * o.length, t
            }, r.stco.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 0; o < n; o++) r[o] = e.readUInt32BE(4 * o + 4);
                return {
                    entries: r
                }
            }, r.stco.encodingLength = function(e) {
                return 4 + 4 * e.entries.length
            }, r.co64 = {}, r.co64.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.co64.encodingLength(e)), t.writeUInt32BE(o.length, 0);
                for (var a = 0; a < o.length; a++) x.encode(o[a], t, 8 * a + 4);
                return r.co64.encode.bytes = 4 + 8 * o.length, t
            }, r.co64.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 0; o < n; o++) r[o] = x.decode(e, 8 * o + 4);
                return {
                    entries: r
                }
            }, r.co64.encodingLength = function(e) {
                return 4 + 8 * e.entries.length
            }, r.stts = {}, r.stts.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.stts.encodingLength(e)), t.writeUInt32BE(o.length, 0);
                for (var a = 0, s; a < o.length; a++) s = 8 * a + 4, t.writeUInt32BE(o[a].count || 0, s), t.writeUInt32BE(o[a].duration || 0, s + 4);
                return r.stts.encode.bytes = 4 + 8 * e.entries.length, t
            }, r.stts.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 0, a; o < n; o++) a = 8 * o + 4, r[o] = {
            ...
            }, r.stts.encodingLength = function(e) {
                return 4 + 8 * e.entries.length
            }, r.ctts = {}, r.ctts.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.ctts.encodingLength(e)), t.writeUInt32BE(o.length, 0);
                for (var a = 0, s; a < o.length; a++) s = 8 * a + 4, t.writeUInt32BE(o[a].count || 0, s), t.writeUInt32BE(o[a].compositionOffset || 0, s + 4);
                return r.ctts.encode.bytes = 4 + 8 * o.length, t
            }, r.ctts.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 0, a; o < n; o++) a = 8 * o + 4, r[o] = {
                    count: e.readUInt32BE(a),
            ...
            }, r.ctts.encodingLength = function(e) {
                return 4 + 8 * e.entries.length
            }, r.stsc = {}, r.stsc.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.stsc.encodingLength(e)), t.writeUInt32BE(o.length, 0);
                for (var a = 0, s; a < o.length; a++) s = 12 * a + 4, t.writeUInt32BE(o[a].firstChunk || 0, s), t.writeUInt32BE(o[a].samplesPerChunk || 0, s + 4), t.writeUInt32BE(o[a].sampleDescriptionId || 0, s + 8);
                return r.stsc.encode.bytes = 4 + 12 * o.length, t
            }, r.stsc.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 0, a; o < n; o++) a = 12 * o + 4, r[o] = {
            ...
            }, r.stsc.encodingLength = function(e) {
                return 4 + 12 * e.entries.length
            }, r.dref = {}, r.dref.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(r.dref.encodingLength(e));
                var o = e.entries || [];
                t.writeUInt32BE(o.length, 0);
                for (var a = 4, s = 0; s < o.length; s++) {
                    var d = o[s],
                        l = (d.buf ? d.buf.length : 0) + 4 + 4;
                    t.writeUInt32BE(l, a), a += 4, t.write(d.type, a, 4, "ascii"), a += 4, d.buf && (d.buf.copy(t, a), a += d.buf.length)
                }
                return r.dref.encode.bytes = a, t
            }, r.dref.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 4, a = 0; a < n; a++) {
            ...
            }, r.dref.encodingLength = function(e) {
                var t = 4;
                if (!e.entries) return t;
                for (var n = 0, r; n < e.entries.length; n++) r = e.entries[n].buf, t += (r ? r.length : 0) + 4 + 4;
                return t
            }, r.elst = {}, r.elst.encode = function(e, t, n) {
                var o = e.entries || [];
                t = t ? t.slice(n) : w(r.elst.encodingLength(e)), t.writeUInt32BE(o.length, 0);
                for (var a = 0, d; a < o.length; a++) d = 12 * a + 4, t.writeUInt32BE(o[a].trackDuration || 0, d), t.writeUInt32BE(o[a].mediaTime || 0, d + 4), s(o[a].mediaRate || 0, t, d + 8);
                return r.elst.encode.bytes = 4 + 12 * o.length, t
            }, r.elst.decode = function(e, t) {
                e = e.slice(t);
                for (var n = e.readUInt32BE(0), r = Array(n), o = 0, a; o < n; o++) a = 12 * o + 4, r[o] = {
            ...
            }, r.elst.encodingLength = function(e) {
                return 4 + 12 * e.entries.length
            }, r.hdlr = {}, r.hdlr.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(r.hdlr.encodingLength(e));
                var o = 21 + (e.name || "").length;
                return t.fill(0, 0, o), t.write(e.handlerType || "", 4, 4, "ascii"), u(e.name || "", t, 20), r.hdlr.encode.bytes = o, t
            }, r.hdlr.decode = function(e, t, n) {
                return e = e.slice(t), {
                    handlerType: e.toString("ascii", 4, 8),
                    name: _(e, 20, n)
                }
            }, r.hdlr.encodingLength = function(e) {
                return 21 + (e.name || "").length
            }, r.mehd = {}, r.mehd.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(4), t.writeUInt32BE(e.fragmentDuration || 0, 0), r.mehd.encode.bytes = 4, t
            }, r.mehd.decode = function(e, t) {
                return e = e.slice(t), {
                    fragmentDuration: e.readUInt32BE(0)
                }
            }, r.mehd.encodingLength = function() {
                return 4
            }, r.trex = {}, r.trex.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(20), t.writeUInt32BE(e.trackId || 0, 0), t.writeUInt32BE(e.defaultSampleDescriptionIndex || 0, 4), t.writeUInt32BE(e.defaultSampleDuration || 0, 8), t.writeUInt32BE(e.defaultSampleSize || 0, 12), t.writeUInt32BE(e.defaultSampleFlags || 0, 16), r.trex.encode.bytes = 20, t
            }, r.trex.decode = function(e, t) {
                return e = e.slice(t), {
            ...
            }, r.trex.encodingLength = function() {
                return 20
            }, r.mfhd = {}, r.mfhd.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(4), t.writeUInt32BE(e.sequenceNumber || 0, 0), r.mfhd.encode.bytes = 4, t
            }, r.mfhd.decode = function(e) {
                return {
                    sequenceNumber: e.readUInt32BE(0)
                }
            }, r.mfhd.encodingLength = function() {
                return 4
            }, r.tfhd = {}, r.tfhd.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(4), t.writeUInt32BE(e.trackId, 0), r.tfhd.encode.bytes = 4, t
            }, r.tfhd.decode = function() {}, r.tfhd.encodingLength = function() {
                return 4
            }, r.tfdt = {}, r.tfdt.encode = function(e, t, n) {
                return t = t ? t.slice(n) : w(4), t.writeUInt32BE(e.baseMediaDecodeTime || 0, 0), r.tfdt.encode.bytes = 4, t
            }, r.tfdt.decode = function() {}, r.tfdt.encodingLength = function() {
                return 4
            }, r.trun = {}, r.trun.encode = function(e, t, n) {
                t = t ? t.slice(n) : w(8 + 16 * e.entries.length), t.writeUInt32BE(e.entries.length, 0), t.writeInt32BE(e.dataOffset, 4);
                for (var o = 8, a = 0, s; a < e.entries.length; a++) s = e.entries[a], t.writeUInt32BE(s.sampleDuration, o), o += 4, t.writeUInt32BE(s.sampleSize, o), o += 4, t.writeUInt32BE(s.sampleFlags, o), o += 4, 0 === (e.version || 0) ? t.writeUInt32BE(s.sampleCompositionTimeOffset, o) : t.writeInt32BE(s.sampleCompositionTimeOffset, o), o += 4;
                r.trun.encode.bytes = o
            }, r.trun.decode = function() {}, r.trun.encodingLength = function(e) {
                return 8 + 16 * e.entries.length
            }, r.mdat = {}, r.mdat.encode = function(e, t, n) {
                e.buffer ? (e.buffer.copy(t, n), r.mdat.encode.bytes = e.buffer.length) : r.mdat.encode.bytes = r.mdat.encodingLength(e)
            }, r.mdat.decode = function(e, t, n) {
                return {
                    buffer: k(e.slice(t, n))
                }
            }, r.mdat.encodingLength = function(e) {
        ...
        107: [function(e, t, n) {
            ...
            n.Descriptor = {}, n.Descriptor.decode = function(e, t, i) {
                var a = e.readUInt8(t),
                    s = t + 1,
                    d = 0,
                    l;
                do l = e.readUInt8(s++), d = d << 7 | 127 & l; while (128 & l);
                var c = o[a],
                    u;
                return u = n[c] ? n[c].decode(e, s, i) : {
                    buffer: r(e.slice(s, s + d))
                }, u.tag = a, u.tagName = c, u.length = s - t + d, u.contentsLen = d, u
            }, n.DescriptorArray = {}, n.DescriptorArray.decode = function(e, t, r) {
                for (var i = t, a = {}; i + 2 <= r;) {
                    var s = n.Descriptor.decode(e, i, r);
                    i += s.length;
                    var d = o[s.tag] || "Descriptor" + s.tag;
                    a[d] = s
                }
                return a
        ...
        108: [function(e, t, n) {
            ...
            d.encode = function(e, t, n) {
                return d.encodingLength(e), n = n || 0, t = t || o(e.length), d._encode(e, t, n)
            }, d._encode = function(e, t, n) {
                var o = e.type,
                    i = e.length;
                i > s && (i = 1), t.writeUInt32BE(i, n), t.write(e.type, n + 4, 4, "ascii");
                var c = n + 8;
                if (1 === i && (r.encode(e.length, t, c), c += 8), a.fullBoxes[o] && (t.writeUInt32BE(e.flags || 0, c), t.writeUInt8(e.version || 0, c), c += 4), l[o]) {
                    var u = l[o];
                ...
                } else throw new Error("Either `type` must be set to a known type (not'" + o + "') or `buffer` must be set");
                ...
                var d, l;
                return a.fullBoxes[i] && (d = e.readUInt8(s), l = 16777215 & e.readUInt32BE(s), s += 4), {
                    length: o,
                    headersLen: s - t,
                    contentLen: o - (s - t),
                    type: i,
                ...
                if (l[o]) {
                    s.otherBoxes = [];
                    for (var c = l[o], u = n, p; 8 <= r - u;)
                        if (p = d.decode(t, u, r), u += p.length, 0 <= c.indexOf(p.type)) s[p.type] = p;
                        else if (0 <= c.indexOf(p.type + "s")) {
                        var f = p.type + "s",
                            h = s[f] = s[f] || [];
                        h.push(p)
                    } else s.otherBoxes.push(p)
                } else if (a[o]) {
                    var m = a[o].decode;
                    s = m(t, n, r)
                } else s.buffer = i(t.slice(n, r));
                return s.length = e.length, s.contentLen = e.contentLen, s.type = e.type, s.version = e.version, s.flags = e.flags, s
            }, d.encodingLength = function(e) {
                var t = e.type,
                    n = 8;
                if (a.fullBoxes[t] && (n += 4), l[t]) {
                    var r = l[t];
                    r.forEach(function(t) {
                        if (5 === t.length) {
                            ...
                            var o = e[t];
                            o.type = t, n += d.encodingLength(o)
                        }
                    }), e.otherBoxes && e.otherBoxes.forEach(function(e) {
                        n += d.encodingLength(e)
                    })
                } else if (a[t]) n += a[t].encodingLength(e);
        ...
        109: [function(e, t) {
            (function(n) {
                ...
                var i = e("readable-stream"),
                    ...
                    l = e("buffer-alloc"),
                    c = l(0);
                t.exports = r, a(r, i.Writable), r.prototype.destroy = function(e) {
                    this.destroyed || (this.destroyed = !0, e && this.emit("error", e), this.emit("close"))
                }, r.prototype._write = function(e, t, n) {
                    if (!this.destroyed) {
                        for (var r = !this._str || !this._str._writableState.needDrain; e.length && !this.destroyed;) {
                            ...
                            if (this._buf ? e.copy(this._buf, this._buf.length - this._missing) : this._str && (r = this._str.write(o === e.length ? e : e.slice(0, o))), this._missing -= o, !this._missing) {
                                var i = this._buf,
                                    a = this._cb,
                                    s = this._str;
                                this._buf = this._cb = this._str = this._ondrain = null, r = !0, s && s.end(), a && a(i)
                            }
                    ...
                    var n = this;
                    return this._missing = e, this._str = new o(this), this._ondrain = s(this._str, "drain"), this._pending++, this._str.on("end", function() {
                        n._pending--, n._kick()
                    ...
                    t._headers = null, t._buffer(n.contentLen, function(r) {
                        var o = d.decodeWithoutHeaders(n, r);
                ...
                }, a(o, i.PassThrough), o.prototype.destroy = function(e) {
        ...
        110: [function(e, t) {
            (function(n) {
                ...
                function o() {
                    ...
                    a.Readable.call(this), this.destroyed = !1, this._reading = !1, this._stream = null, this._drain = null, this._want = !1, this._onreadable = function() {
                ...
                var a = e("readable-stream"),
                    ...
                    d = e("mp4-box-encoding"),
                    l = e("buffer-alloc");
                t.exports = o, s(o, a.Readable), o.prototype.mediaData = o.prototype.mdat = function(e, t) {
                    var n = new i(this);
                    return this.box({
                        type: "mdat",
                        contentLength: e,
                ...
                }, o.prototype.box = function(e, t) {
                    if (t || (t = r), this.destroyed) return t(new Error("Encoder is destroyed"));
                    var o;
                    if (e.encodeBufferLen && (o = l(e.encodeBufferLen)), e.stream) e.buffer = null, o = d.encode(e, o), this.push(o), this._stream = e.stream, this._stream.on("readable", this._onreadable), this._stream.on("end", this._onend), this._stream.on("end", t), this._forward();
                    else {
                        o = d.encode(e, o);
                        var i = this.push(o);
                        if (i) return n.nextTick(t);
                        this._drain = t
                    }
                }, o.prototype.destroy = function(e) {
                    if (!this.destroyed) {
                ...
                }, s(i, a.PassThrough), i.prototype.destroy = function(e) {
                    this.destroyed || (this.destroyed = !0, this._parent.destroy(e), e && this.emit("error", e), this.emit("close"))
                }
            }).call(this, e("_process"))
        }, {
        ...
        121: [function(e, t) {
            function n(e, t) {
                var i = this;
                return i instanceof n ? void(d.Readable.call(i, t), i.destroyed = !1, i._drained = !1, i._forwarding = !1, i._current = null, i._toStreams2 = t && t.objectMode ? r : o, "function" == typeof e ? i._queue = e : (i._queue = e.map(i._toStreams2), i._queue.forEach(function(e) {
                    "function" != typeof e && i._attachErrorListener(e)
                })), i._next()) : new n(e, t)
            }
            ...
            function i(e, t) {
                ...
                var n = new d.Readable(t).wrap(e);
                return e.destroy && (n.destroy = e.destroy.bind(e)), n
            }
            t.exports = n;
            var a = e("inherits"),
                d = e("readable-stream");
            a(n, d.Readable), n.obj = function(e) {
                return new n(e, {
                    objectMode: !0,
                    highWaterMark: 16
                })
        ...
        134: [function(e, t) {
            (function(n, r) {
                function o(e) {
                    if ("string" == typeof e && /^(stream-)?magnet:/.test(e)) return h(e);
                    if ("string" == typeof e && (/^[a-f0-9]{40}$/i.test(e) || /^[a-z2-7]{32}$/i.test(e))) return h(`magnet:?xt=urn:btih:${e}`);
                    if (r.isBuffer(e) && 20 === e.length) return h(`magnet:?xt=urn:btih:${e.toString("hex")}`);
                ...
                function i(e) {
                    ...
                    }) : e.announce && t.announce.push(e.announce.toString()), r.isBuffer(e["url-list"]) && (e["url-list"] = 0 < e["url-list"].length ? [e["url-list"]] : []), t.urlList = (e["url-list"] || []).map(e => e.toString()), _(t.announce), _(t.urlList);
                    const n = e.info.files || [e.info];
                    t.files = n.map((e, r) => {
                        const o = [].concat(t.name, e["path.utf-8"] || e.path || []).map(e => e.toString());
                        return {
                            path: m.join.apply(null, [m.sep].concat(o)).slice(1),
                            name: o[o.length - 1],
                            length: e.length,
                            offset: n.slice(0, r).reduce(s, 0)
                        }
                    }), t.length = n.reduce(s, 0);
                    const o = t.files[t.files.length - 1];
                    return t.pieceLength = e.info["piece length"], t.lastPieceLength = (o.offset + o.length) % t.pieceLength || t.pieceLength, t.pieces = d(e.info.pieces), t
                }
                ...
                t.exports = o, t.exports.remote = function(e, t) {
                    ...
                    i && i.infoHash ? n.nextTick(() => {
                        t(null, i)
                    }) : a(e) ? u(e, (e, n) => e ? t(new Error(`Error converting Blob: ${e.message}`)) : void r(n)) : "function" == typeof f && /^https?:/.test(e) ? f.concat({
                        url: e,
                        timeout: 30000,
                        headers: {
                            "user-agent": "WebTorrent (https://webtorrent.io)"
                        }
                    }, (e, n, o) => e ? t(new Error(`Error downloading torrent: ${e.message}`)) : void r(o)) : "function" == typeof p.readFile && "string" == typeof e ? p.readFile(e, (e, n) => e ? t(new Error("Invalid torrent identifier")) : void r(n)) : n.nextTick(() => {
                        t(new Error("Invalid torrent identifier"))
                    })
                }, t.exports.toMagnetURI = h.encode, t.exports.toTorrentFile = function(e) {
                    const t = {
                        info: e.info
                    };
            ...
            (function(e) {
                ...
                function r(e) {
                    ...
                    for (o = e.length - 1; 0 <= o; --o)
                        if (!(47 === e.charCodeAt(o))) - 1 === n && (r = !1, n = o + 1);
                        else if (!r) {
                        t = o + 1;
                        break
                    }
                ...
                n.resolve = function() {
                    for (var n = "", r = !1, a = arguments.length - 1, s; - 1 <= a && !r; a--) {
                        if (s = 0 <= a ? arguments[a] : e.cwd(), "string" != typeof s) throw new TypeError("Arguments to path.resolve must be strings");
                        else if (!s) continue;
                        n = s + "/" + n, r = "/" === s.charAt(0)
                    }
                    ...
                    for (var o = r(e.split("/")), a = r(t.split("/")), s = d(o.length, a.length), l = s, c = 0; c < s; c++)
                        if (o[c] !== a[c]) {
                            l = c;
                            break
                        }
                    ...
                    for (var t = e.charCodeAt(0), n = 47 === t, r = -1, o = !0, a = e.length - 1; 1 <= a; --a)
                    ...
                    "string" != typeof e && (e += "");
                    for (var t = -1, n = 0, r = -1, o = !0, a = 0, s = e.length - 1, d; 0 <= s; --s) {
                        if (d = e.charCodeAt(s), 47 === d) {
                            ...
                            continue
                        } - 1 === r && (o = !1, r = s + 1), 46 === d ? -1 === t ? t = s : 1 !== a && (a = 1) : -1 !== t && (a = -1)
                    }
        ...
        136: [function(e, n) {
            for (var r = e("closest-to"), o = t(2, 10), i = 13, a = []; 22 > i++;) a.push(t(2, i));
                ...
                t.exports = e.version && 0 !== e.version.indexOf("v0.") && (0 !== e.version.indexOf("v1.") || 0 === e.version.indexOf("v1.8.")) ? e : {
                    nextTick: function(t, n, r, o) {
                        ...
                        switch (a) {
                            ...
                            default:
                                for (s = Array(a - 1), d = 0; d < s.length;) s[d++] = arguments[d];
                                return e.nextTick(function() {
                                    t.apply(null, s)
                                });
                        }
        ...
        138: [function(e, t) {
            ...
            function a() {
                h && g && (h = !1, g.length ? f = g.concat(f) : m = -1, f.length && s())
            }
            ...
            c.nextTick = function(e) {
                ...
                f.push(new d(e, t)), 1 !== f.length || h || o(s)
        ...
        139: [function(e, t) {
            (function(n) {
                var r = e("once"),
                    ...
                    i = e("fs"),
                    a = function() {},
                    s = /^v?\.0/.test(n.version),
                    d = function(e) {
                        return "function" == typeof e
                    },
                    l = function(e) {
                        return !!s && !!i && (e instanceof(i.ReadStream || a) || e instanceof(i.WriteStream || a)) && d(e.close)
                    },
                    c = function(e) {
                    ...
                    u = function(e, t, n, i) {
                        ...
                        e.on("close", function() {
                            ...
                            return e ? i(e) : void(s = !0, i())
                        });
                        var u = !1;
                        return function(t) {
                            if (!s) return u ? void 0 : (u = !0, l(e) ? e.close(a) : c(e) ? e.abort() : d(e.destroy) ? e.destroy() : void i(t || new Error("stream was destroyed")))
                        }
                    },
                    p = function(e) {
                        e()
        ...
        140: [function(e, t, r) {
            (function(e) { /*! https://mths.be/punycode v1.4.1 by @mathias */
                (function(i) {
                    function a(e) {
                    ...
                    function d(e, t) {
                        var n = e.split("@"),
                            r = "";
                        1 < n.length && (r = n[0] + "@", e = n[1]), e = e.replace(x, ".");
                        var o = e.split("."),
                            i = s(o, t).join(".");
                        return r + i
                    }
                    ...
                    function u(e) {
                        return s(e, function(e) {
                            var t = "";
                            return 65535 < e && (e -= 65536, t += v(55296 | 1023 & e >>> 10), e = 56320 | 1023 & e), t += v(e), t
                        }).join("")
                    }
                    ...
                    function m(e) {
                        var r = [],
                            ...
                            l = 72,
                            c, f, m, g, _, b, y, x, C, v;
                        for (f = e.lastIndexOf("-"), 0 > f && (f = 0), m = 0; m < f; ++m) 128 <= e.charCodeAt(m) && a("not-basic"), r.push(e.charCodeAt(m));
                        for (g = 0 < f ? f + 1 : 0; g < o;) {
                            for (_ = s, b = 1, y = 36;; y += 36) {
                                if (g >= o && a("invalid-input"), x = p(e.charCodeAt(g++)), (36 <= x || x > S((2147483647 - s) / b)) && a("overflow"), s += x * b, C = y <= l ? 1 : y >= l + 26 ? 26 : y - l, x < C) break;
                                v = 36 - C, b > S(2147483647 / v) && a("overflow"), b *= v
                            }
                            c = r.length + 1, l = h(s - _, c, 0 == _), S(s / c) > 2147483647 - d && a("overflow"), d += S(s / c), s %= c, r.splice(s++, 0, d)
                        }
                        return u(r)
                    }
                    ...
                    function g(e) {
                        var r = [],
                            o, i, s, d, l, u, p, g, _, b, y, w, x, C, E;
                        for (e = c(e), w = e.length, o = 128, i = 0, l = 72, u = 0; u < w; ++u) y = e[u], 128 > y && r.push(v(y));
                        for (s = d = r.length, d && r.push("-"); s < w;) {
                            for (p = 2147483647, u = 0; u < w; ++u) y = e[u], y >= o && y < p && (p = y);
                            for (x = s + 1, p - o > S((2147483647 - i) / x) && a("overflow"), i += (p - o) * x, o = p, u = 0; u < w; ++u)
                                if (y = e[u], y < o && 2147483647 < ++i && a("overflow"), y == o) {
                                    for (g = i, _ = 36;; _ += 36) {
                                        if (b = _ <= l ? 1 : _ >= l + 26 ? 26 : _ - l, g < b) break;
                                        E = g - b, C = 36 - b, r.push(v(f(b + E % C, 0))), g = S(E / C)
                                    }
                                    r.push(v(f(g, 0))), l = h(i, x, s == d), i = 0, ++s
                                }++i, ++o
                        }
                        return r.join("")
                    }
                    ...
                    else if (!(_ && b)) i.punycode = E;
                    else if (t.exports == _) b.exports = E;
                    else
                        for (L in E) E.hasOwnProperty(L) && (_[L] = E[L])
                })(this)
            ...
            t.exports = function(e, t, o, a) {
                ...
                for (var u = 0; u < c; ++u) {
                    var p = e[u].replace(d, "%20"),
                        f = p.indexOf(o),
                        h, m, g, _;
                    0 <= f ? (h = p.substr(0, f), m = p.substr(f + 1)) : (h = p, m = ""), g = decodeURIComponent(h), _ = decodeURIComponent(m), n(s, g) ? r(s[g]) ? s[g].push(_) : s[g] = [s[g], _] : s[g] = _
                }
                return s
            };
        ...
        145: [function(e, t) {
            (function(n, r) {
                ...
                t.exports = i && i.getRandomValues ? function(e, t) {
                    ...
                    0 < e && i.getRandomValues(a);
                    var s = o.from(a.buffer);
        ...
        146: [function(e, t) {
            ...
            t.exports = n, r(n, o.Writable), n.prototype._write = function(e, t, n) {
                for (var r = this, o = !0;;) {
                    ...
                    r._buffer = null;
                    var i = r._queue[0],
                        a = s(i.start - r._position, 0),
                        d = i.end - r._position;
                    if (a >= e.length) return r._position += e.length, n(null);
                    var l;
                    if (d > e.length) {
                        r._position += e.length, l = 0 === a ? e : e.slice(a), o = i.stream.write(l) && o;
                        break
                    }
                    r._position += d, l = 0 === a && d === e.length ? e : e.slice(a, d), o = i.stream.write(l) && o, i.last && i.stream.end(), e = e.slice(d), r._queue.shift()
                }
        ...
        147: [function(e, t, n) {
            ...
            "./_stream_readable": 149,
            "./_stream_writable": 151,
            "core-util-is": 66,
            dup: 18,
            inherits: 87,
            "process-nextick-args": 137
        ...
        149: [function(e, t, n) {
            ...
            "./_stream_duplex": 147,
            "./internal/streams/BufferList": 152,
            "./internal/streams/destroy": 153,
            "./internal/streams/stream": 154,
            _process: 138,
            "core-util-is": 66,
            dup: 20,
            events: 48,
        ...
        155: [function(e, t, n) {
            ...
            "./lib/_stream_duplex.js": 147,
            "./lib/_stream_passthrough.js": 148,
            "./lib/_stream_readable.js": 149,
            "./lib/_stream_transform.js": 150,
            "./lib/_stream_writable.js": 151,
            dup: 26
        }],
        156: [function(e, t) {
            function n(e, t) {
            ...
            function i(e, t, i) {
                ...
                var s = function(e) {
                    function t(e, o, i) {
                        return n(this, t), r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, a(e, o, i)))
                    }
                    return o(t, e), t
                }(i);
                s.prototype.name = i.name, s.prototype.code = e, u[e] = s
            }
            ...
            i("ERR_INVALID_OPT_VALUE", function(e, t) {
                ...
                var r;
                "string" == typeof t && s(t, "not ") ? (r = "must not be", t = t.replace(/^not /, "")) : r = "must be";
                var o;
                if (d(e, " argument")) o = "The " + e + " " + r + " " + a(t, "type");
                else {
                    var i = l(e, ".") ? "property" : "argument";
                    o = "The \"" + e + "\" " + i + " " + r + " " + a(t, "type")
                }
                return o += ". Received type " + ("undefined" == typeof n ? "undefined" : c(n)), o
        ...
        158: [function(e, t) {
            (function(n) {
                ...
                e("inherits")(r, s);
                for (var l = a(d.prototype), c = 0, u; c < l.length; c++) u = l[c], r.prototype[u] || (r.prototype[u] = d.prototype[u]);
        ...
        160: [function(e, t) {
            (function(n, r) {
                ...
                function l(e, t, n, r, i) {
                    ...
                    if (null === t) a.reading = !1, h(e, a);
                        ...
                        var s;
                        if (i || (s = u(a, t)), s) e.emit("error", s);
                        else if (!(a.objectMode || t && 0 < t.length)) r || (a.reading = !1, _(e, a));
                        else if ("string" == typeof t || a.objectMode || Object.getPrototypeOf(t) === U.prototype || (t = o(t)), r) a.endEmitted ? e.emit("error", new V) : c(e, a, t, !0);
                        else if (a.ended) e.emit("error", new W);
                        else {
                            if (a.destroyed) return !1;
                            a.reading = !1, a.decoder && !n ? (t = a.decoder.write(t), a.objectMode || 0 !== t.length ? c(e, a, t, !1) : _(e, a)) : c(e, a, t, !1)
                        }
                    }
                ...
                function c(e, t, n, r) {
                    t.flowing && 0 === t.length && !t.sync ? (t.awaitDrain = 0, e.emit("data", n)) : (t.length += t.objectMode ? 1 : n.length, r ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && m(e)), _(e, t)
                }

                function u(e, t) {
                    var n;
                    return i(t) || "string" == typeof t || void 0 === t || e.objectMode || (n = new D("chunk", ["string", "Buffer", "Uint8Array"], t)), n
                }
                ...
                function h(e, t) {
                    if (!t.ended) {
                        ...
                        t.ended = !0, t.sync ? m(e) : (t.needReadable = !1, !t.emittedReadable && (t.emittedReadable = !0, g(e)))
                    }
                }

                function m(e) {
                    var t = e._readableState;
                    t.needReadable = !1, t.emittedReadable || (O("emitReadable", t.flowing), t.emittedReadable = !0, n.nextTick(g, e))
                }

                function g(e) {
                    var t = e._readableState;
                    O("emitReadable_", t.destroyed, t.length, t.ended), !t.destroyed && (t.length || t.ended) && e.emit("readable"), t.needReadable = !t.flowing && !t.ended && t.length <= t.highWaterMark, S(e)
                }
                ...
                function b(e, t) {
                    for (var n = t.length; !t.reading && !t.ended && t.length < t.highWaterMark && (O("maybeReadMore read 0"), e.read(0), n !== t.length);) n = t.length;
                    t.readingMore = !1
                }
                ...
                function y(e) {
                    return function() {
                        var t = e._readableState;
                        O("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && R(e, "data") && (t.flowing = !0, S(e))
                    }
                }

                function w(e) {
                    e._readableState.readableListening = 0 < e.listenerCount("readable"), 0 < e.listenerCount("data") && e.resume()
                }
                ...
                function C(e, t) {
                    O("resume", t.reading), t.reading || e.read(0), t.resumeScheduled = !1, e.emit("resume"), S(e), t.flowing && !t.reading && e.read(0)
                }
                ...
                function E(e) {
                    var t = e._readableState;
                    O("endReadable", t.endEmitted), t.endEmitted || (t.ended = !0, n.nextTick(L, t, e))
                }

                function L(e, t) {
                    O("endReadableNT", e.endEmitted, e.length), e.endEmitted || 0 !== e.length || (e.endEmitted = !0, t.readable = !1, t.emit("end"))
                }
                ...
                var j = e("./internal/streams/buffer_list"),
                    N = e("./internal/streams/destroy"),
                    F = e("./internal/streams/state"),
                    H = F.getHighWaterMark,
                    q = e("../errors").codes,
                    D = q.ERR_INVALID_ARG_TYPE,
                    W = q.ERR_STREAM_PUSH_AFTER_EOF,
                    z = q.ERR_METHOD_NOT_IMPLEMENTED,
                    V = q.ERR_STREAM_UNSHIFT_AFTER_END_EVENT,
                ...
                Object.defineProperty(d.prototype, "destroyed", {
                    ...
                    var n = this._readableState,
                        r;
                    return n.objectMode ? r = !0 : "string" == typeof e && (t = t || n.defaultEncoding, t !== n.encoding && (e = U.from(e, t), t = ""), r = !0), l(this, e, t, !1, r)
                }, d.prototype.unshift = function(e) {
                    return l(this, e, null, !0, !1)
                }, d.prototype.isPaused = function() {
                    return !1 === this._readableState.flowing
                }, d.prototype.setEncoding = function(t) {
                    return Y || (Y = e("string_decoder/").StringDecoder), this._readableState.decoder = new Y(t), this._readableState.encoding = this._readableState.decoder.encoding, this
                };
                d.prototype.read = function(e) {
                    O("read", e), e = parseInt(e, 10);
                    var t = this._readableState,
                        r = e;
                    if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 === t.highWaterMark ? 0 < t.length : t.length >= t.highWaterMark) || t.ended)) return O("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? E(this) : m(this), null;
                    if (e = f(e, t), 0 === e && t.ended) return 0 === t.length && E(this), null;
                    var o = t.needReadable;
                    O("need readable", o), (0 === t.length || t.length - e < t.highWaterMark) && (o = !0, O("length less than watermark", o)), t.ended || t.reading ? (o = !1, O("reading or ended", o)) : o && (O("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, !t.reading && (e = f(r, t)));
                    var i;
                    return i = 0 < e ? v(e, t) : null, null === i ? (t.needReadable = !0, e = 0) : (t.length -= e, t.awaitDrain = 0), 0 === t.length && (!t.ended && (t.needReadable = !0), r !== e && t.ended && E(this)), null !== i && this.emit("data", i), i
                }, d.prototype._read = function() {
                    this.emit("error", new z("_read()"))
                }, d.prototype.pipe = function(e, t) {
                    function r(e, t) {
                        O("onunpipe"), e === p && t && !1 === t.hasUnpiped && (t.hasUnpiped = !0, i())
                    }
                    ...
                    function i() {
                        O("cleanup"), e.removeListener("close", l), e.removeListener("finish", c), e.removeListener("drain", g), e.removeListener("error", d), e.removeListener("unpipe", r), p.removeListener("end", o), p.removeListener("end", u), p.removeListener("data", s), _ = !0, f.awaitDrain && (!e._writableState || e._writableState.needDrain) && g()
                    }

                    function s(t) {
                        O("ondata");
                        var n = e.write(t);
                        O("dest.write", n), !1 === n && ((1 === f.pipesCount && f.pipes === e || 1 < f.pipesCount && -1 !== I(f.pipes, e)) && !_ && (O("false write response, pause", f.awaitDrain), f.awaitDrain++), p.pause())
                    }

                    function d(t) {
                        O("onerror", t), u(), e.removeListener("error", d), 0 === R(e, "error") && e.emit("error", t)
                    }
                    ...
                    function c() {
                        O("onfinish"), e.removeListener("close", l), u()
                    }
                    ...
                    f.pipesCount += 1, O("pipe count=%d opts=%j", f.pipesCount, t);
                    var h = (!t || !1 !== t.end) && e !== n.stdout && e !== n.stderr,
                        m = h ? o : u;
                    f.endEmitted ? n.nextTick(m) : p.once("end", m), e.on("unpipe", r);
                    var g = y(p);
                    e.on("drain", g);
                    var _ = !1;
                    return p.on("data", s), a(e, "error", d), e.once("close", l), e.once("finish", c), e.emit("pipe", p), f.flowing || (O("pipe resume"), p.resume()), e
                    ...
                    return "data" === e ? (o.readableListening = 0 < this.listenerCount("readable"), !1 !== o.flowing && this.resume()) : "readable" == e && !o.endEmitted && !o.readableListening && (o.readableListening = o.needReadable = !0, o.flowing = !1, o.emittedReadable = !1, O("on readable", o.length, o.reading), o.length ? m(this) : !o.reading && n.nextTick(k, this)), r
                    ...
                    var e = this._readableState;
                    return e.flowing || (O("resume"), e.flowing = !e.readableListening, x(this, e)), this
                    ...
                    for (var a in e.on("end", function() {
                            ...
                            if ((O("wrapped data"), r.decoder && (n = r.decoder.write(n)), !(r.objectMode && (null === n || void 0 === n))) && (r.objectMode || n && n.length)) {
                                var i = t.push(n);
                                i || (o = !0, e.pause())
                            }
                        }), e) void 0 === this[a] && "function" == typeof e[a] && (this[a] = function(t) {
                    ...
                    return this._read = function(t) {
                        O("wrapped _read", t), o && (o = !1, e.resume())
                    }, this
                }, "function" == typeof Symbol && (d.prototype[Symbol.asyncIterator] = function() {
                    return K("Readable[Symbol.asyncIterator]"), void 0 === X && (X = e("./internal/streams/async_iterator")), new X(this)
            ...
            "../errors": 156,
            "../experimentalWarning": 157,
            "./_stream_duplex": 158,
            "./internal/streams/async_iterator": 163,
            "./internal/streams/buffer_list": 164,
            "./internal/streams/destroy": 165,
            "./internal/streams/state": 166,
            "./internal/streams/stream": 167,
            _process: 138,
            buffer: 47,
            events: 48,
            inherits: 87,
        ...
        161: [function(e, t) {
            ...
            function o() {
                var e = this;
                "function" != typeof this._flush || this._readableState.destroyed ? i(this, null, null) : this._flush(function(t, n) {
                    i(e, t, n)
                })
            }
        ...
        162: [function(e, t) {
            (function(n, r) {
                ...
                function a(e) {
                    return T.isBuffer(e) || e instanceof R
                }

                function s() {}

                function d(t, n, r) {
                    L = L || e("./_stream_duplex"), t = t || {}, "boolean" != typeof r && (r = n instanceof L), this.objectMode = !!t.objectMode, r && (this.objectMode = this.objectMode || !!t.writableObjectMode), this.highWaterMark = P(this, t, "writableHighWaterMark", r), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
                    ...
                    this.decodeStrings = !i, this.defaultEncoding = t.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
                        _(n, e)
                    }, this.writecb = null, this.writelen = 0, this.bufferedRequest = null, this.lastBufferedRequest = null, this.pendingcb = 0, this.prefinished = !1, this.errorEmitted = !1, this.emitClose = !1 !== t.emitClose, this.bufferedRequestCount = 0, this.corkedRequestsFree = new o(this)
                }

                function l(t) {
                    L = L || e("./_stream_duplex");
                    var n = this instanceof L;
                    return n || z.call(l, this) ? void(this._writableState = new d(t, this, n), this.writable = !0, t && ("function" == typeof t.write && (this._write = t.write), "function" == typeof t.writev && (this._writev = t.writev), "function" == typeof t.destroy && (this._destroy = t.destroy), "function" == typeof t.final && (this._final = t.final)), B.call(this)) : new l(t)
                }
                ...
                function u(e, t, r, o) {
                    var i;
                    return null === r ? i = new q : "string" != typeof r && !t.objectMode && (i = new O("chunk", ["string", "Buffer"], r)), !i || (e.emit("error", i), n.nextTick(o, i), !1)
                }
                ...
                function h(e, t, n, r, o, i, a) {
                    t.writelen = r, t.writecb = a, t.writing = !0, t.sync = !0, t.destroyed ? t.onwrite(new H("write")) : n ? e._writev(o, t.onwrite) : e._write(o, i, t.onwrite), t.sync = !1
                }

                function m(e, t, r, o, i) {
                    --t.pendingcb, r ? (n.nextTick(i, o), n.nextTick(S, e, t), e._writableState.errorEmitted = !0, e.emit("error", o)) : (i(o), e._writableState.errorEmitted = !0, e.emit("error", o), S(e, t))
                }
                ...
                function _(e, t) {
                    var r = e._writableState,
                        o = r.sync,
                        i = r.writecb;
                    if ("function" != typeof i) throw new N;
                    if (g(r), t) m(e, r, o, t, i);
                    else {
                        var a = k(r);
                        a || r.corked || r.bufferProcessing || !r.bufferedRequest || w(e, r), o ? n.nextTick(b, e, r, a, i) : b(e, r, a, i)
                    }
                }
                ...
                function w(e, t) {
                    ...
                    if (e._writev && n && n.next) {
                        ...
                        i.allBuffers = d, h(e, t, !0, t.length, i, "", a.finish), t.pendingcb++, t.lastBufferedRequest = null, a.next ? (t.corkedRequestsFree = a.next, a.next = null) : t.corkedRequestsFree = new o(t), t.bufferedRequestCount = 0
                    } else {
                        for (; n;) {
                            var l = n.chunk,
                                c = n.encoding,
                ...
                var I = {
                    ...
                    N = M.ERR_MULTIPLE_CALLBACK,
                    F = M.ERR_STREAM_CANNOT_PIPE,
                    H = M.ERR_STREAM_DESTROYED,
                    q = M.ERR_STREAM_NULL_VALUES,
                    D = M.ERR_STREAM_WRITE_AFTER_END,
                    W = M.ERR_UNKNOWN_ENCODING;
                e("inherits")(l, B), d.prototype.getBuffer = function() {
                        for (var e = this.bufferedRequest, t = []; e;) t.push(e), e = e.next;
                        return t
                    },
                    function() {
                ...
                var z;
                "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (z = Function.prototype[Symbol.hasInstance], Object.defineProperty(l, Symbol.hasInstance, {
                    value: function(e) {
                        return !!z.call(this, e) || !(this !== l) && e && e._writableState instanceof d
                    }
                })) : z = function(e) {
                    return e instanceof this
                    ...
                    var r = this._writableState,
                        o = !1,
                        d = !r.objectMode && a(e);
                    return d && !T.isBuffer(e) && (e = i(e)), "function" == typeof t && (n = t, t = null), d ? t = "buffer" : !t && (t = r.defaultEncoding), "function" != typeof n && (n = s), r.ending ? c(this, n) : (d || u(this, r, e, n)) && (r.pendingcb++, o = f(this, r, d, e, t, n)), o
                    ...
                    var r = this._writableState;
                    return "function" == typeof e ? (n = e, e = null, t = null) : "function" == typeof t && (n = t, t = null), null !== e && void 0 !== e && this.write(e, t), r.corked && (r.corked = 1, this.uncork()), r.ending || v(this, r, n), this
        ...
        163: [function(e, t) {
            (function(e) {
                ...
                function r(e) {
                    ...
                    if (null !== t) {
                        var n = e[m].read();
                        null !== n && (e[f] = null, e[l] = null, e[c] = null, t(new g(n, !1)))
                    }
                }
                ...
                function i(e) {
                    var t = e[l];
                    null !== t && (e[f] = null, e[l] = null, e[c] = null, t(new g(null, !0))), e[p] = !0
                }
                ...
                var d = function() {
                    ...
                    _ = function() {
                        function e(t) {
                            var r = this;
                            n(this, e), this[m] = t, this[l] = null, this[c] = null, this[u] = null, this[p] = !1, this[f] = null, t.on("readable", o.bind(null, this)), t.on("end", i.bind(null, this)), t.on("error", a.bind(null, this)), this[h] = function(e, t) {
                                var n = r[m].read();
                                n ? (r[f] = null, r[l] = null, r[c] = null, e(new g(n, !1))) : (r[l] = e, r[c] = t)
                            }
                        }
                        return e.prototype.next = function() {
                            var e = this[u];
                            if (null !== e) return Promise.reject(e);
                            if (this[p]) return Promise.resolve(new g(null, !0));
                            var t = this[f],
                                n = void 0;
                            if (t) n = new Promise(s(t, this));
                            else {
                                var r = this[m].read();
                                if (null !== r) return Promise.resolve(new g(r, !1));
                            ...
                            return new Promise(function(t, n) {
                                e[m].destroy(null, function(e) {
                                    return e ? void n(e) : void t(new g(null, !0))
                                })
                            })
                        }, d(e, [{
                            key: "stream",
                ...
                return e.prototype.push = function(e) {
                    ...
                    for (e -= o.length; t = t.next;) {
                        ...
                        if (o += a === i.length ? i : i.slice(0, e), e -= a, 0 === e) {
                            a === i.length ? (++r, this.head = t.next ? t.next : this.tail = null) : (this.head = t, t.data = i.slice(a));
                            break
                        }++r
                    }
                    ...
                    for (r.data.copy(t), e -= r.data.length; r = r.next;) {
                        ...
                        if (i.copy(t, t.length - e, 0, s), e -= s, 0 === e) {
                            s === i.length ? (++o, this.head = r.next ? r.next : this.tail = null) : (this.head = r, r.data = i.slice(s));
                            break
                        }++o
                    }
            ...
            (function(e) {
                ...
                t.exports = {
                    destroy: function(t, i) {
                        ...
                        return s || d ? (i ? i(t) : t && (!this._writableState || !this._writableState.errorEmitted) && e.nextTick(o, this, t), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(t || null, function(t) {
                            !i && t ? (e.nextTick(n, a, t), a._writableState && (a._writableState.errorEmitted = !0)) : i ? (e.nextTick(r, a), i(t)) : e.nextTick(r, a)
                        }), this)
                    },
                    undestroy: function() {
        ...
        169: [function(e, t, n) {
            function r(e, t, n, r) {
                ...
                function s() {
                    S.removeEventListener("canplay", s), r(null, S)
                }

                function p() {
                    o(e, function(e, n) {
                        return e ? k(e) : void(".pdf" === x ? (S = t("object"), S.setAttribute("typemustmatch", !0), S.setAttribute("type", "application/pdf"), S.setAttribute("data", n)) : (S = t("iframe"), S.sandbox = "allow-forms allow-scripts", S.src = n), r(null, S))
                    })
                }
                ...
                0 <= g.indexOf(x) ? function() {
                    function r() {
                        d("Use `videostream` package for " + e.name), _(), S.addEventListener("error", p), S.addEventListener("loadstart", i), S.addEventListener("canplay", s), f(e, S)
                    }

                    function l() {
                        d("Use MediaSource API for " + e.name), _(), S.addEventListener("error", g), S.addEventListener("loadstart", i), S.addEventListener("canplay", s);
                        var t = new c(S),
                            n = t.createWriteStream(a(e.name));
                        e.createReadStream().pipe(n), C && (S.currentTime = C)
                    }

                    function u() {
                        d("Use Blob URL for " + e.name), _(), S.addEventListener("error", k), S.addEventListener("loadstart", i), S.addEventListener("canplay", s), o(e, function(e, t) {
                            return e ? k(e) : void(S.src = t, C && (S.currentTime = C))
                        })
                    }

                    function p(e) {
                        d("videostream error: fallback to MediaSource API: %o", e.message || e), S.removeEventListener("error", p), S.removeEventListener("canplay", s), l()
                    }

                    function g(t) {
                        return d("MediaSource API error: fallback to Blob URL: %o", t.message || t), "number" == typeof e.length && e.length > n.maxBlobLength ? (d("File length too large for Blob URL approach: %d (max: %d)", e.length, n.maxBlobLength), k(new Error("File length too large for Blob URL approach: " + e.length + " (max: " + n.maxBlobLength + ")"))) : void(S.removeEventListener("error", g), S.removeEventListener("canplay", s), u())
                    }

                    function _() {
                        S || (S = t(b), S.addEventListener("progress", function() {
                            C = S.currentTime
                        }))
                    }
                    var b = 0 <= m.indexOf(x) ? "video" : "audio";
                    w ? 0 <= h.indexOf(x) ? r() : l() : u()
                }() : 0 <= _.indexOf(x) ? function() {
                    S = t("audio"), o(e, function(e, t) {
                        return e ? k(e) : void(S.addEventListener("error", k), S.addEventListener("loadstart", i), S.addEventListener("canplay", s), S.src = t)
                    })
                }() : 0 <= b.indexOf(x) ? function() {
                    S = t("img"), o(e, function(t, n) {
                        return t ? k(t) : void(S.src = n, S.alt = e.name, r(null, S))
                    })
                }() : 0 <= y.indexOf(x) ? p() : function() {
                    function t() {
            ...
            n.render = function(e, t, n, o) {
                "function" == typeof n && (o = n, n = {}), n || (n = {}), o || (o = function() {}), i(e), s(n), "string" == typeof t && (t = document.querySelector(t)), r(e, function(n) {
                ...
                if ("function" == typeof n && (o = n, n = {}), n || (n = {}), o || (o = function() {}), i(e), s(n), "string" == typeof t && (t = document.querySelector(t)), t && ("VIDEO" === t.nodeName || "AUDIO" === t.nodeName)) throw new Error("Invalid video/audio node argument. Argument must be root element that video/audio tag will be appended to.");
                r(e, function(e) {
                    return "video" === e || "audio" === e ? a(e) : d(e)
                }, n, l)
            ...
            var d = e("debug")("render-media"),
                ...
                m = [".m4v", ".mkv", ".mp4", ".webm"],
                g = [].concat(m, [".m4a", ".mp3"]),
                _ = [".aac", ".oga", ".ogg", ".wav", ".flac"],
                b = [".bmp", ".gif", ".jpeg", ".jpg", ".png", ".svg"],
                y = [".css", ".html", ".js", ".md", ".pdf", ".txt"],
                w = "undefined" != typeof window && window.MediaSource
        }, {
            "./lib/mime.json": 170,
            debug: 171,
            "is-ascii": 88,
        ...
        174: [function(e, t) {
            (function(e) {
                t.exports = function(t, n, r) {
                    ...
                    function a(e, n, r) {
                        if (d[e] = r, n && (p = !0), 0 == --c || n) o(n);
                        else if (!p && f < l) {
                            var i;
                            u ? (i = u[f], f += 1, t[i](function(e, t) {
                                a(i, e, t)
                            })) : (i = f, f += 1, t[i](function(e, t) {
                                a(i, e, t)
                            }))
                        }
                    }
                    ...
                    var s = !0,
                        d, l, c, u, p;
                    Array.isArray(t) ? (d = [], c = l = t.length) : (u = Object.keys(t), d = {}, c = l = u.length);
                    var f = n;
        ...
        175: [function(e, t) {
            (function(e) {
                t.exports = function(t, n) {
                    ...
                    var i = !0,
                        a, s, d;
                    Array.isArray(t) ? (a = [], s = t.length) : (d = Object.keys(t), a = {}, s = d.length), s ? d ? d.forEach(function(e) {
                        t[e](function(t, n) {
                            o(e, t, n)
                        })
        ...
        176: [function(e, t, n) {
            (function(e, r) {
                "object" == typeof n && "object" == typeof t ? t.exports = r() : "function" == typeof l && l.amd ? l([], r) : "object" == typeof n ? n.Rusha = r() : e.Rusha = r()
                ...
                return function(e) {
                    ...
                    var o = n(5),
                        ...
                        h = function() {
                            function e(t) {
                                ...
                                this._offset = 0, this._maxChunkLen = t, this._padMaxChunkLen = c(t), this._heap = new ArrayBuffer(s(this._padMaxChunkLen + 320 + 20)), this._h32 = new Int32Array(this._heap), this._h8 = new Int8Array(this._heap), this._core = new o({
                            ...
                            return e.prototype._initState = function(e, t) {
                                ...
                                return this._coreCall(e, n, t - n, t, !0), f(this._heap, this._padMaxChunkLen)
                                ...
                                var t = 0,
                                    ...
                                    o = void 0;
                                for (this._offset += n; t < n;) o = d(n - t, this._maxChunkLen - r), this._write(e, t, o, r), r += o, t += o, r === this._maxChunkLen && (this._core.hash(this._maxChunkLen, this._padMaxChunkLen), r = 0);
                                return this
                    ...
                    e.exports.toHex = function(e) {
                        for (var n = new Uint8Array(e), r = Array(e.byteLength), o = 0; o < r.length; o++) r[o] = t[n[o]];
                        return r.join("")
                    ...
                    var r = n(4),
                        ...
                        a = n(2),
                        s = n(1),
                        d = s.isDedicatedWorkerScope,
                        l = "undefined" != typeof self && d(self);
                    o.disableWorkerBehaviour = l ? a() : function() {}, o.createWorker = function() {
                        var e = r(2),
                            t = e.terminate;
                    ...
                    function i(e, t, r) {
                        ...
                        if (!s) return i;
                        for (var d = s[1], l = new RegExp("(\\\\n|\\W)" + o(d) + "\\((/\\*.*?\\*/)?s?.*?([\\.|\\-|\\+|\\w|/|@]+).*?\\)", "g"), c; c = l.exec(a);) "dll-reference" !== c[3] && i[r].push(c[3]);
                        for (l = new RegExp("\\(" + o(d) + "\\(\"(dll-reference\\s([\\.|\\-|\\+|\\w|/|@]+))\"\\)\\)\\((/\\*.*?\\*/)?s?.*?([\\.|\\-|\\+|\\w|/|@]+).*?\\)", "g"); c = l.exec(a);) e[c[2]] || (i[r].push(c[1]), e[c[2]] = n(c[1]).m), i[c[2]] = i[c[2]] || [], i[c[2]].push(c[4]);
                        return i
                    }
                    ...
                    function s(e, t) {
                        for (var n = {
                            ...
                            for (var s = Object.keys(n), d = 0; d < s.length; d++) {
                                var l = s[d],
                                    c = n[l],
                                    u = c.pop();
                                if (o[l] = o[l] || {}, !o[l][u] && e[l][u]) {
                                    o[l][u] = !0, r[l] = r[l] || [], r[l].push(u);
                                    for (var p = i(e, e[l][u], l), f = Object.keys(p), h = 0; h < f.length; h++) n[f[h]] = n[f[h]] || [], n[f[h]] = n[f[h]].concat(p[f[h]])
                                }
                            }
                        return r
                    }
                    e.exports = function(e, t) {
                        ...
                        Object.keys(i).filter(function(e) {
                            ...
                            for (var t = 0; i[e][t];) t++;
                            i[e].push(t), o[e][t] = "(function(module, exports, __webpack_require__) { module.exports = __webpack_require__; })", a = a + "var " + e + " = (" + r.toString().replace("ENTRY_MODULE", JSON.stringify(t)) + ")({" + i[e].map(function(t) {
                        ...
                        return {
                            hash: function(e, t) {
                                ...
                                var n = 0,
                                    ...
                                    m = 0,
                                    g = 0;
                                for (i = 0 | r[t + 320 >> 2], s = 0 | r[t + 324 >> 2], l = 0 | r[t + 328 >> 2], u = 0 | r[t + 332 >> 2], f = 0 | r[t + 336 >> 2], n = 0;
                                    (0 | n) < (0 | e); n = 0 | n + 64) {
                                    for (a = i, d = s, c = l, p = u, h = f, o = 0; 64 > (0 | o); o = 0 | o + 4) g = 0 | r[n + o >> 2], m = 0 | (0 | (i << 5 | i >>> 27) + (s & l | ~s & u)) + (0 | (0 | g + f) + 1518500249), f = u, u = l, l = s << 30 | s >>> 2, s = i, i = m, r[e + o >> 2] = g;
                                    for (o = 0 | e + 64;
                                        (0 | o) < (0 | e + 80); o = 0 | o + 4) g = (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) << 1 | (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) >>> 31, m = 0 | (0 | (i << 5 | i >>> 27) + (s & l | ~s & u)) + (0 | (0 | g + f) + 1518500249), f = u, u = l, l = s << 30 | s >>> 2, s = i, i = m, r[o >> 2] = g;
                                    for (o = 0 | e + 80;
                                        (0 | o) < (0 | e + 160); o = 0 | o + 4) g = (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) << 1 | (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) >>> 31, m = 0 | (0 | (i << 5 | i >>> 27) + (s ^ l ^ u)) + (0 | (0 | g + f) + 1859775393), f = u, u = l, l = s << 30 | s >>> 2, s = i, i = m, r[o >> 2] = g;
                                    for (o = 0 | e + 160;
                                        (0 | o) < (0 | e + 240); o = 0 | o + 4) g = (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) << 1 | (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) >>> 31, m = 0 | (0 | (i << 5 | i >>> 27) + (s & l | s & u | l & u)) + (0 | (0 | g + f) - 1894007588), f = u, u = l, l = s << 30 | s >>> 2, s = i, i = m, r[o >> 2] = g;
                                    for (o = 0 | e + 240;
                                        (0 | o) < (0 | e + 320); o = 0 | o + 4) g = (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) << 1 | (r[o - 12 >> 2] ^ r[o - 32 >> 2] ^ r[o - 56 >> 2] ^ r[o - 64 >> 2]) >>> 31, m = 0 | (0 | (i << 5 | i >>> 27) + (s ^ l ^ u)) + (0 | (0 | g + f) - 899497514), f = u, u = l, l = s << 30 | s >>> 2, s = i, i = m, r[o >> 2] = g;
                                    i = 0 | i + a, s = 0 | s + d, l = 0 | l + c, u = 0 | u + p, f = 0 | f + h
                                }
                                r[t + 320 >> 2] = i, r[t + 324 >> 2] = s, r[t + 328 >> 2] = l, r[t + 332 >> 2] = u, r[t + 336 >> 2] = f
                            }
                        }
                    }
                }, function(e) {
                    ...
                    var r = function(e, t, n, r, o, a) {
                            ...
                            switch (s) {
                                ...
                                case 1:
                                    t[0 | a + 1 - (s << 1)] = e.charCodeAt(r + 2);
                                case 2:
                                    t[0 | a + 2 - (s << 1)] = e.charCodeAt(r + 1);
                                case 3:
                                    t[0 | a + 3 - (s << 1)] = e.charCodeAt(r);
                            }
                            if (!(o < d + (4 - s))) {
                                for (c = 4 - s; c < l; c = 0 | c + 4) n[a + c >> 2] = e.charCodeAt(r + c) << 24 | e.charCodeAt(r + c + 1) << 16 | e.charCodeAt(r + c + 2) << 8 | e.charCodeAt(r + c + 3);
                                switch (d) {
                                    case 3:
                        ...
                        o = function(e, t, n, r, o, a) {
                            ...
                            if (!(o < d + (4 - s))) {
                                for (c = 4 - s; c < l; c = 0 | c + 4) n[0 | a + c >> 2] = e[r + c] << 24 | e[r + c + 1] << 16 | e[r + c + 2] << 8 | e[r + c + 3];
                                switch (d) {
                                    case 3:
                                        t[0 | a + l + 1] = e[r + l + 2];
                                    case 2:
                        ...
                        i = function(e, t, r, o, a, s) {
                            var d = void 0,
                                l = s % 4,
                                c = (a + l) % 4,
                                u = a - c,
                                p = new Uint8Array(n.readAsArrayBuffer(e.slice(o, o + a)));
                            switch (l) {
                                case 0:
                                    t[s] = p[3];
                                case 1:
                    ...
                    e.exports = function(e, n, a, s, d, l) {
                        if ("string" == typeof e) return r(e, n, a, s, d, l);
                        if (e instanceof Array) return o(e, n, a, s, d, l);
                        if (t && t.Buffer && t.Buffer.isBuffer(e)) return o(e, n, a, s, d, l);
                        if (e instanceof ArrayBuffer) return o(new Uint8Array(e), n, a, s, d, l);
                        if (e.buffer instanceof ArrayBuffer) return o(new Uint8Array(e.buffer, e.byteOffset, e.byteLength), n, a, s, d, l);
                        if (e instanceof Blob) return i(e, n, a, s, d, l);
                    ...
                    var o = n(0),
                        ...
                        s = function() {
                            function e() {
                                r(this, e), this._rusha = new o, this._rusha.resetState()
                            }
        ...
        177: [function(e, t, n) {
            ...
            var i = e("buffer"),
                a = i.Buffer;
            a.from && a.alloc && a.allocUnsafe && a.allocUnsafeSlow ? t.exports = i : (r(i, n), n.Buffer = o), r(a, o), o.from = function(e, t, n) {
            ...
            (function(n) {
                function r(e, t) {
                    if (e = Object.assign({
                        ...
                        delete e.url, t || n || r || o ? Object.assign(e, {
                            hostname: t,
                            port: n,
                            protocol: r,
                            auth: o,
                    ...
                    e.headers && Object.keys(e.headers).forEach(t => o[t.toLowerCase()] = e.headers[t]), e.headers = o;
                    let p;
                    ...
                    }), h.on("error", t), u(p) ? p.on("error", t).pipe(h) : h.end(p), h
                }
                t.exports = r;
                ...
                r.concat = (e, t) => r(e, (n, r) => n ? t(n) : void o(r, (n, o) => {
                    if (n) return t(n);
                    if (e.json) try {
            ...
            (function(n) {
                function r(e) {
                    ...
                    if (t._id = l(4).toString("hex").slice(0, 7), t._debug("new peer %o", e), e = Object.assign({
                        ...
                        if ("undefined" == typeof window) throw o("No WebRTC support: Specify `opts.wrtc` option in this environment", "ERR_WEBRTC_SUPPORT");
                        else throw o("No WebRTC support: Not a supported browser", "ERR_WEBRTC_SUPPORT");
                ...
                d(r, c.Duplex), r.WEBRTC_SUPPORT = !!s(), r.config = {
                    ...
                    if (!e.destroyed) {
                        ...
                        e._debug("iceStateChange (connection: %s) (gathering: %s)", t, n), e.emit("iceStateChange", t, n), ("connected" === t || "completed" === t) && (e._pcReady = !0, e._maybeReady()), "failed" === t && e.destroy(o("Ice connection failed.", "ERR_ICE_CONNECTION_FAILURE")), "closed" === t && e.destroy(new Error("Ice connection closed."))
                    }
                        ...
                        t.destroyed || t.getStats(function(n, r) {
                            ...
                            if (!t.destroyed) {
                                ...
                                if (r.forEach(function(e) {
                                        ("remotecandidate" === e.type || "remote-candidate" === e.type) && (a[e.id] = e), ("localcandidate" === e.type || "local-candidate" === e.type) && (s[e.id] = e), ("candidatepair" === e.type || "candidate-pair" === e.type) && (d[e.id] = e)
                                    }), r.forEach(function(e) {
                                        "transport" === e.type && e.selectedCandidatePairId && i(d[e.selectedCandidatePairId]), ("googCandidatePair" === e.type && "true" === e.googActiveConnection || ("candidatepair" === e.type || "candidate-pair" === e.type) && e.selected) && i(e)
        ...
        193: [function(e, t) {
            ...
            function r(e, t) {
                return c ? void("string" == typeof e && (e = o(e)), c.digest({
                    name: "sha-1"
                }, e).then(function(e) {
        ...
        194: [function(e, t) {
            (function(n, r) {
                function o(e) {
                    ...
                    if (t._id = s(4).toString("hex").slice(0, 7), t._debug("new websocket: %o", e), e = Object.assign({
                            allowHalfOpen: !1
                ...
                var i = e("debug")("simple-websocket"),
                    ...
                    u = 65536;
                a(o, d.Duplex), o.WEBSOCKET_SUPPORT = !!c, o.prototype.send = function(e) {
                    this._ws.send(e)
                }, o.prototype.destroy = function(e) {
                    ...
                    if (!n.destroyed) {
                        ...
                        if (n._ws = null, e) {
                            if ("undefined" != typeof DOMException && e instanceof DOMException) {
                                var i = e.code;
                                e = new Error(e.message), e.code = i
                            }
                            n.emit("error", e)
                        }
                        n.emit("close"), t()
        ...
        198: [function(e, t, n) {
            ...
            "./_stream_readable": 200,
            "./_stream_writable": 202,
            "core-util-is": 66,
            dup: 18,
            inherits: 87,
            "process-nextick-args": 137
        ...
        200: [function(e, t, n) {
            ...
            "./_stream_duplex": 198,
            "./internal/streams/BufferList": 203,
            "./internal/streams/destroy": 204,
        ...
        206: [function(e, t, n) {
            ...
            "./lib/_stream_duplex.js": 198,
            "./lib/_stream_passthrough.js": 199,
            "./lib/_stream_readable.js": 200,
            "./lib/_stream_transform.js": 201,
            "./lib/_stream_writable.js": 202,
            dup: 26
        }],
        207: [function(e, t) {
            var n = 1,
            ...
            t.exports = function(e) {
                ...
                return function(e) {
                    var i = n - l & r;
                    for (i > t && (i = t), l = n; i--;) d === t && (d = 0), s[d] = s[0 === d ? t - 1 : d - 1], d++;
                    e && (s[d - 1] += e);
                    var a = s[d - 1],
                        c = s.length < t ? 0 : s[d === t ? 0 : d];
                    return s.length < o ? a : (a - c) * o / s.length
                }
            }
        }, {}],
        208: [function(e, t, n) {
        ...
        209: [function(e, t, n) {
            (function(e) {
                ...
                var i = "undefined" != typeof e.ArrayBuffer,
                    ...
                    s;
                n.arraybuffer = n.fetch || i && r("arraybuffer"), n.msstream = !n.fetch && a && r("ms-stream"), n.mozchunkedarraybuffer = !n.fetch && i && r("moz-chunked-arraybuffer"), n.overrideMimeType = n.fetch || !!t() && o(t().overrideMimeType), n.vbArray = o(e.VBArray), s = null
            }).call(this, "undefined" == typeof global ? "undefined" == typeof self ? "undefined" == typeof window ? {} : window : self : global)
        }, {}],
        210: [function(e, t) {
            (function(n, r, o) {
                ...
                var s = e("./capability"),
                    ...
                    h = t.exports = function(e) {
                        ...
                        var n = !0,
                            r;
                        if ("disable-fetch" === e.mode || "requestTimeout" in e && !s.abortController) n = !1, r = !0;
                ...
                d(h, c.Writable), h.prototype.setHeader = function(e, t) {
                    var n = this,
                    ...
                    if (!e._destroyed) {
                        var t = e._opts,
                            i = e._headers,
                            a = null;
                        "GET" !== t.method && "HEAD" !== t.method && (s.arraybuffer ? a = u(o.concat(e._body)) : s.blobConstructor ? a = new r.Blob(e._body.map(function(e) {
                            return u(e)
                        }), {
                            type: (i["content-type"] || {}).value || ""
                        }) : a = o.concat(e._body).toString());
                        var d = [];
        ...
        211: [function(e, t, n) {
            (function(t, r, o) {
                var i = e("./capability"),
                    ...
                    l = n.IncomingMessage = function(e, n, a, d) {
                        var l = this;
                        if (s.Readable.call(l), l._mode = a, l.headers = {}, l.rawHeaders = [], l.trailers = {}, l.rawTrailers = [], l.on("end", function() {
                            ...
                            function e() {
                                u.read().then(function(t) {
                                    return l._destroyed ? void 0 : t.done ? (r.clearTimeout(d), void l.push(null)) : void(l.push(new o(t.value)), e())
                                }).catch(function(e) {
                            ...
                            if (l._fetchResponse = n, l.url = n.url, l.statusCode = n.status, l.statusMessage = n.statusText, n.headers.forEach(function(e, t) {
                                ...
                                var c = new WritableStream({
                                    write: function(e) {
                                        return new Promise(function(t, n) {
                                            l._destroyed ? n() : l.push(new o(e)) ? t() : l._resumeFetch = t
                                        })
                                    },
                                    close: function() {
                            ...
                            if (p.forEach(function(e) {
                                ...
                                }), l._charset = "x-user-defined", !i.overrideMimeType) {
                ...
                a(l, s.Readable), l.prototype._read = function() {
                    ...
                    switch (t._mode) {
                        case "text:vbarray":
                            if (n.readyState !== d.DONE) break;
                            try {
                                a = new r.VBArray(n.responseBody).toArray()
                            } catch (t) {}
                            if (null !== a) {
                                t.push(new o(a));
                                break
                        ...
                        case "text":
                            ...
                            if (a.length > t._pos) {
                                var s = a.substr(t._pos);
                                if ("x-user-defined" === t._charset) {
                                    for (var l = new o(s.length), c = 0; c < s.length; c++) l[c] = 255 & s.charCodeAt(c);
                                    t.push(l)
                            ...
                            break;
                        case "arraybuffer":
                            if (n.readyState !== d.DONE || !n.response) break;
                            a = n.response, t.push(new o(new Uint8Array(a)));
                            break;
                        case "moz-chunked-arraybuffer":
                            if (a = n.response, n.readyState !== d.LOADING || !a) break;
                            t.push(new o(new Uint8Array(a)));
                            break;
                        case "ms-stream":
                            if (a = n.response, n.readyState !== d.LOADING) break;
                            var e = new r.MSStreamReader;
                            e.onprogress = function() {
                                e.result.byteLength > t._pos && (t.push(new o(new Uint8Array(e.result.slice(t._pos)))), t._pos = e.result.byteLength)
                            }, e.onload = function() {
                                t.push(null)
        ...
        212: [function(e, t, n) {
            ...
            "./_stream_readable": 214,
            "./_stream_writable": 216,
            "core-util-is": 66,
            dup: 18,
            inherits: 87,
            "process-nextick-args": 137
        ...
        214: [function(e, t, n) {
            ...
            "./_stream_duplex": 212,
            "./internal/streams/BufferList": 217,
            "./internal/streams/destroy": 218,
            "./internal/streams/stream": 219,
            _process: 138,
            "core-util-is": 66,
            dup: 20,
            events: 48,
        ...
        220: [function(e, t, n) {
            ...
            "./lib/_stream_duplex.js": 212,
            "./lib/_stream_passthrough.js": 213,
            "./lib/_stream_readable.js": 214,
            "./lib/_stream_transform.js": 215,
            "./lib/_stream_writable.js": 216,
            dup: 26
        }],
        221: [function(e, t) {
        ...
        224: [function(e, t, n) {
            ...
            function s(e, t, n) {
                ...
                if (r < n) return 0;
                var o = a(t[r]);
                return 0 <= o ? (0 < o && (e.lastNeed = o - 1), o) : --r < n || -2 === o ? 0 : (o = a(t[r]), 0 <= o) ? (0 < o && (e.lastNeed = o - 2), o) : --r < n || -2 === o ? 0 : (o = a(t[r]), 0 <= o ? (0 < o && (2 === o ? o = 0 : e.lastNeed = o - 3), o) : 0)
            }
        ...
        226: [function(e, t, r) {
            (function(e) {
                ...
                r.encode = function(n) {
                    ...
                    for (var r = 0, o = 0, a = 0, s = 0, d = new e(8 * t(n)); r < n.length;) {
                        var l = n[r];
                        3 < a ? (s = l & 255 >> a, a = (a + 5) % 8, s = s << a | (r + 1 < n.length ? n[r + 1] : 0) >> 8 - a, r++) : (s = 31 & l >> 8 - (a + 5), a = (a + 5) % 8, 0 === a && r++), d[o] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567".charCodeAt(s), o++
                    }
                    ...
                    for (var l = new e(a(5 * t.length / 8)), c = 0; c < t.length && !(61 === t[c]); c++) {
                        var u = t[c] - 48;
                        if (u < o.length) r = o[u], 3 >= n ? (n = (n + 5) % 8, 0 == n ? (d |= r, l[s] = d, s++, d = 0) : d |= 255 & r << 8 - n) : (n = (n + 5) % 8, d |= 255 & r >>> n, l[s] = d, s++, d = 255 & r << 8 - n);
        ...
        229: [function(e, t) {
            (function(r) {
                ...
                t.exports = class extends a {
                    constructor(e) {
                        ...
                        if (!e.infoHash) throw new Error("Option `infoHash` is required");
                        if (!r.browser && !e.port) throw new Error("Option `port` is required");
                    ...
                    _dhtAnnounce() {
                        this._dhtAnnouncing || (o("dht announce"), this._dhtAnnouncing = !0, clearTimeout(this._dhtTimeout), this.dht.announce(this.infoHash, this._port, e => {
                            this._dhtAnnouncing = !1, o("dht announce complete"), e && this.emit("warning", e), this.emit("dhtAnnounce"), this.destroyed || (this._dhtTimeout = setTimeout(() => {
                                this._dhtAnnounce()
                            }, this._intervalMs + n(Math.random() * this._intervalMs / 5)), this._dhtTimeout.unref && this._dhtTimeout.unref())
                        }))
                    }
                }
            }).call(this, e("_process"))
            ...
            _process: 138,
            "bittorrent-dht/client": 45,
            "bittorrent-tracker/client": 27,
            debug: 230,
            events: 48,
            "run-parallel": 175
        }],
        ...
        233: [function(e, t) {
            (function(e) {
                ...
                class r {
                    constructor(e) {
                        this.length = e, this.missing = e, this.sources = null, this._chunks = a(e / n), this._remainder = e % n || n, this._buffered = 0, this._buffer = null, this._cancellations = null, this._reservations = 0, this._flushed = !1
                    }
                    chunkLength(e) {
                    ...
                    set(e, t, r) {
                        ...
                        for (let o = 0; o < i; o++)
                            if (!this._buffer[e + o]) {
                                const i = o * n,
                                    a = t.slice(i, i + n);
                                this._buffered++, this._buffer[e + o] = a, this.missing -= a.length, this.sources.includes(r) || this.sources.push(r)
                            }
        ...
        235: [function(e, r, o) {
            ...
            o.encodingLength = function() {
                ...
                t || (t = i(8)), r || (r = 0);
                var o = n(e / a);
                return t.writeUInt32BE(o, r), t.writeUInt32BE(e - o * a, r + 4), t
        ...
        238: [function(e, t, n) {
            ...
            r.prototype.parse = function(e, t, n) {
                ...
                var r = e.indexOf("?"),
                    ...
                    u = e.split(o),
                    f = /\\/g;
                u[0] = u[0].replace(f, "/"), e = u.join(o);
                var S = e;
                if (S = S.trim(), !n && 1 === e.split("#").length) {
                    var v = p.exec(S);
                    if (v) return this.path = S, this.href = S, this.pathname = v[1], v[2] ? (this.search = v[2], this.query = t ? C.parse(this.search.substr(1)) : this.search.substr(1)) : t && (this.search = "", this.query = {}), this
                }
                var E = c.exec(S);
                if (E) {
                    E = E[0];
                    var L = E.toLowerCase();
                    this.protocol = L, S = S.substr(E.length)
                }
                if (n || E || S.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                    var I = "//" === S.substr(0, 2);
                    I && !(E && w[E]) && (S = S.substr(2), this.slashes = !0)
                }
                if (!w[E] && (I || E && !x[E])) {
                    for (var B = -1, T = 0, R; T < g.length; T++) R = S.indexOf(g[T]), -1 !== R && (-1 === B || R < B) && (B = R);
                    var A, U;
                    U = -1 === B ? S.lastIndexOf("@") : S.lastIndexOf("@", B), -1 !== U && (A = S.slice(0, U), S = S.slice(U + 1), this.auth = decodeURIComponent(A)), B = -1;
                    for (var T = 0, R; T < m.length; T++) R = S.indexOf(m[T]), -1 !== R && (-1 === B || R < B) && (B = R); - 1 === B && (B = S.length), this.host = S.slice(0, B), S = S.slice(B), this.parseHost(), this.hostname = this.hostname || "";
                    var P = "[" === this.hostname[0] && "]" === this.hostname[this.hostname.length - 1];
                    if (!P)
                        for (var M = this.hostname.split(/\./), T = 0, O = M.length, N; T < O; T++)
                            if (N = M[T], N && !N.match(_)) {
                                for (var F = "", H = 0, q = N.length; H < q; H++) F += 127 < N.charCodeAt(H) ? "x" : N[H];
                                if (!F.match(_)) {
                                    var k = M.slice(0, T),
                                        D = M.slice(T + 1),
                                        W = N.match(b);
                                    W && (k.push(W[1]), D.unshift(W[2])), D.length && (S = "/" + D.join(".") + S), this.hostname = k.join(".");
                                    break
                                }
                            }
                    this.hostname = 255 < this.hostname.length ? "" : this.hostname.toLowerCase(), P || (this.hostname = a.toASCII(this.hostname));
                    var z = this.port ? ":" + this.port : "",
                        V = this.hostname || "";
                    this.host = V + z, this.href += this.host, P && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== S[0] && (S = "/" + S))
                }
                if (!y[L])
                    for (var T = 0, O = h.length, G; T < O; T++)
                        if (G = h[T], -1 !== S.indexOf(G)) {
                            var K = encodeURIComponent(G);
                            K === G && (K = escape(G)), S = S.split(G).join(K)
                        }
                var Y = S.indexOf("#"); - 1 !== Y && (this.hash = S.substr(Y), S = S.slice(0, Y));
                var X = S.indexOf("?");
                if (-1 === X ? t && (this.search = "", this.query = {}) : (this.search = S.substr(X), this.query = S.substr(X + 1), t && (this.query = C.parse(this.query)), S = S.slice(0, X)), S && (this.pathname = S), x[L] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                    var z = this.pathname || "",
                        $ = this.search || "";
                    this.path = z + $
                }
                ...
                var t = this.protocol || "",
                    ...
                    o = !1,
                    i = "";
                this.host ? o = e + this.host : this.hostname && (o = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (o += ":" + this.port)), this.query && d.isObject(this.query) && Object.keys(this.query).length && (i = C.stringify(this.query));
                ...
                for (var n = new r, o = Object.keys(this), a = 0, l; a < o.length; a++) l = o[a], n[l] = this[l];
                ...
                if (e.protocol && e.protocol !== n.protocol) {
                    ...
                    if (n.protocol = e.protocol, !e.host && !w[e.protocol]) {
                        ...
                        e.host || (e.host = ""), e.hostname || (e.hostname = ""), "" !== _[0] && _.unshift(""), 2 > _.length && _.unshift(""), n.pathname = _.join("/")
                ...
                var s = n.pathname && "/" === n.pathname.charAt(0),
                    ...
                    C = y || s || n.host && e.pathname,
                    S = C,
                    E = n.pathname && n.pathname.split("/") || [],
                    _ = e.pathname && e.pathname.split("/") || [],
                    L = n.protocol && !x[n.protocol];
                if (L && (n.hostname = "", n.port = null, n.host && ("" === E[0] ? E[0] = n.host : E.unshift(n.host)), n.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === _[0] ? _[0] = e.host : _.unshift(e.host)), e.host = null), C = C && ("" === _[0] || "" === E[0])), y) n.host = e.host || "" === e.host ? e.host : n.host, n.hostname = e.hostname || "" === e.hostname ? e.hostname : n.hostname, n.search = e.search, n.query = e.query, E = _;
                else if (_.length) E || (E = []), E.pop(), E = E.concat(_), n.search = e.search, n.query = e.query;
                ...
                if (!E.length) return n.pathname = null, n.path = n.search ? "/" + n.search : null, n.href = n.format(), n;
                for (var B = E.slice(-1)[0], T = (n.host || e.host || 1 < E.length) && ("." === B || ".." === B) || "" === B, R = 0, A = E.length; 0 <= A; A--) B = E[A], "." === B ? E.splice(A, 1) : ".." === B ? (E.splice(A, 1), R++) : R && (E.splice(A, 1), R--);
                if (!C && !S)
                    for (; R--; R) E.unshift("..");
                C && "" !== E[0] && (!E[0] || "/" !== E[0].charAt(0)) && E.unshift(""), T && "/" !== E.join("/").substr(-1) && E.push("");
                var U = "" === E[0] || E[0] && "/" === E[0].charAt(0);
                if (L) {
                    n.hostname = n.host = U ? "" : E.length ? E.shift() : "";
                    var I = !!(n.host && 0 < n.host.indexOf("@")) && n.host.split("@");
                    I && (n.auth = I.shift(), n.host = n.hostname = I.shift())
                }
                return C = C || n.host && E.length, C && !U && E.unshift(""), E.length ? n.pathname = E.join("/") : (n.pathname = null, n.path = null), d.isNull(n.pathname) && d.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = e.auth || n.auth, n.slashes = n.slashes || e.slashes, n.href = n.format(), n
        ...
        240: [function(e, t) {
            (function(n) {
                const {
                    EventEmitter: r
                } = e("events"), o = e("bencode"), i = e("bitfield"), s = e("debug")("ut_metadata"), d = e("simple-sha1"), l = 1E3, c = 16384;
                t.exports = e => {
                    class t extends r {
                        constructor(t) {
                            super(), this._wire = t, this._fetching = !1, this._metadataComplete = !1, this._metadataSize = null, this._remainingRejects = null, this._bitfield = new i(0, {
                                grow: l
                        ...
                        setMetadata(e) {
                            ...
                            return !(this._infoHash && this._infoHash !== d.sync(e)) && (this.cancel(), this.metadata = e, this._metadataComplete = !0, this._metadataSize = this.metadata.length, this._wire.extendedHandshake.metadata_size = this._metadataSize, this.emit("metadata", o.encode({
                        ...
                        _onData(e, t) {
                            t.length > c || (t.copy(this.metadata, e * c), this._bitfield.set(e), this._checkDone())
                        }
                        _onReject(e) {
        ...
        245: [function(e, t) {
            (function(r) {
                ...
                var d = e("binary-search"),
                    i = e("events").EventEmitter,
                    l = e("inherits"),
                    c = e("mp4-stream"),
                    u = e("mp4-box-encoding"),
                    p = e("range-slice-stream");
                t.exports = o, l(o, i), o.prototype._findMoov = function(e) {
                    var t = this;
                    ...
                    for (var o = 0; o < n.length; o++) {
                        ...
                        if ("vide" === p && "avc1" === c.type) {
                            ...
                            t._hasVideo = !0, f = "avc1", c.avcC && (f += "." + c.avcC.mimeCodec), h = "video/mp4; codecs=\"" + f + "\""
                        } else if ("soun" === p && "mp4a" === c.type) {
                            if (t._hasAudio) continue;
                            t._hasAudio = !0, f = "mp4a", c.esds && c.esds.mimeCodec && (f += "." + c.esds.mimeCodec), h = "audio/mp4; codecs=\"" + f + "\""
                        } else continue;
                        var m = [],
                            g = 0,
                            _ = 0,
                            ...
                            C = null;
                        l.ctts && (C = new a(l.ctts.entries));
                        for (var S = 0;;) {
                            var v = l.stsc.entries[w],
                                E = l.stsz.entries[g],
                                L = x.value.duration,
                                I = C ? C.value.compositionOffset : 0,
                                B = !0;
                            l.stss && (B = l.stss.entries[S] === g + 1);
                            var T = l.stco || l.co64;
                            if (m.push({
                                    size: E,
                                    duration: L,
                                    ...
                                    sync: B,
                                    offset: y + T.entries[b]
                                }), g++, g >= l.stsz.entries.length) break;
                            if (_++, y += E, _ >= v.samplesPerChunk) {
                                _ = 0, y = 0, b++;
                                var R = l.stsc.entries[w + 1];
                                R && b + 1 >= R.firstChunk && w++
                            }
                            k += L, x.inc(), C && C.inc(), B && S++
                        }
                        d.mdia.mdhd.duration = 0, d.tkhd.duration = 0;
                        var A = v.sampleDescriptionId,
                            U = {
                                type: "moov",
                                mvhd: e.mvhd,
                                traks: [{
                    ...
                    var P = u.encode(t._ftyp),
                        M = t._tracks.map(function(e) {
                            var t = u.encode(e.moov);
                            return {
                                mime: e.mime,
                                init: r.concat([P, t])
                            }
                    ...
                    if (t._tracks.map(function(r, o) {
                            function i(e) {
                                a.destroyed || a.box(e.moof, function(n) {
                                    if (n) return t.emit("error", n);
                                    if (!a.destroyed) {
                                        var s = r.inStream.slice(e.ranges);
                                        s.pipe(a.mediaData(e.length, function(e) {
                                            if (e) return t.emit("error", e);
                                            if (!a.destroyed) {
                                                var n = t._generateFragment(o);
                                                return n ? void i(n) : a.finalize()
                                            }
                                        }))
                                    }
                                })
                            ...
                            var a = r.outStream = c.encode(),
                                s = t._generateFragment(o, e);
                            return s ? void((-1 === n || s.ranges[0].start < n) && (n = s.ranges[0].start), i(s)) : a.finalize()
                        }), 0 <= n) {
                    ...
                    var r = this,
                        o = r._tracks[e],
                        i = n(o.timeScale * t),
                        a = d(o.samples, i, function(e, n) {
                            var t = e.dts + e.presentationOffset;
                            return t - n
                        });
                    for (-1 === a ? a = 0 : 0 > a && (a = -a - 2); !o.samples[a].sync;) a--;
                    return a
                };
                o.prototype._generateFragment = function(e, t) {
                    ...
                    for (var i = r.samples[o].dts, a = 0, s = [], d = o, l; d < r.samples.length && (l = r.samples[d], !(l.sync && l.dts - i >= 1 * r.timeScale)); d++) {
                        a += l.size;
                        var c = s.length - 1;
                        0 > c || s[c].end !== l.offset ? s.push({
                            start: l.offset,
                            end: l.offset + l.size
                        }) : s[c].end += l.size
                    }
                    return r.currSample = d, {
                        moof: n._generateMoof(e, o, d),
                        ranges: s,
                        length: a
                    }
                }, o.prototype._generateMoof = function(e, t, n) {
                    for (var r = this, o = r._tracks[e], i = [], a = 0, s = t, d; s < n; s++) d = o.samples[s], 0 > d.presentationOffset && (a = 1), i.push({
                    ...
                    return l.trafs[0].trun.dataOffset += u.encodingLength(l), l
                }
            }).call(this, e("buffer").Buffer)
        }, {
            "binary-search": 12,
        ...
        251: [function(e, t) {
            (function(n, r) {
                ...
                class C extends s {
                    ...
                    add(e, t = {}, n) {
                        function r() {
                            a.removeListener("_infoHash", o), a.removeListener("ready", i), a.removeListener("close", r)
                        }
                        ...
                        const o = () => {
                                if (!this.destroyed)
                                    for (const e of this.torrents)
                                        if (e.infoHash === a.infoHash && e !== a) return void a._destroy(new Error(`Cannot add duplicate torrent ${a.infoHash}`))
                            },
                            i = () => {
                                this.destroyed || ("function" == typeof n && n(a), this.emit("torrent", a))
                            };
                        this._debug("add"), t = t ? Object.assign({}, t) : {};
                        const a = new w(e, this, t);
                        return this.torrents.push(a), a.once("_infoHash", o), a.once("ready", i), a.once("close", r), a
                    }
                    seed(e, t, n) {
                        if (this.destroyed) throw new Error("client is destroyed");
                        "function" == typeof t && ([t, n] = [{}, t]), this._debug("seed"), t = t ? Object.assign({}, t) : {}, t.skipVerify = !0;
                        const r = "string" == typeof e;
                        r && (t.path = m.dirname(e)), t.createdBy || (t.createdBy = `WebTorrent/${x}`);
                        const a = e => {
                            ...
                            s = this.add(null, t, e => {
                                ...
                                }), f(t, t => this.destroyed ? void 0 : t ? e._destroy(t) : void a(e))
                            });
                        let c;
                        return i(e) ? e = Array.from(e) : !Array.isArray(e) && (e = [e]), f(e.map(e => t => {
                            o(e) ? d(e, t) : t(null, e)
                        }), (e, n) => this.destroyed ? void 0 : e ? s._destroy(e) : void l.parseInput(n, t, (e, r) => this.destroyed ? void 0 : e ? s._destroy(e) : void(c = r.map(e => e.getStream), l(n, t, (e, t) => {
                            if (!this.destroyed) {
                ...
                C.WEBRTC_SUPPORT = g.WEBRTC_SUPPORT, C.VERSION = k, t.exports = C
            }).call(this, e("_process"), "undefined" == typeof global ? "undefined" == typeof self ? "undefined" == typeof window ? {} : window : self : global)
        }, {
            "./lib/tcp-pool": 45,
            "./lib/torrent": 5,
