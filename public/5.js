webpackJsonp([5],Array(92).concat([
/* 92 */
...
var _camera = __webpack_require__(186);
...
var _ar = __webpack_require__(187);

var _ar2 = _interopRequireDefault(_ar);

var _es = __webpack_require__(188);

var _es2 = _interopRequireDefault(_es);

var _EstadoCivil = __webpack_require__(189);

var _EstadoCivil2 = _interopRequireDefault(_EstadoCivil);

var _ProfileImage = __webpack_require__(185);
...
var CambiarDatos = function (_Component) {
  ...
  function CambiarDatos(props) {
    ...
    _this.handleSuccessfulUpdate = _this.handleSuccessfulUpdate.bind(_this);
    _this.handleErrorOnUpdate = _this.handleErrorOnUpdate.bind(_this);
  ...
  _createClass(CambiarDatos, [{
    ...
    value: function componentDidMount() {
      ...
      var _props = this.props,
          ...
          fetchMaritalStatus = _props.fetchMaritalStatus,
          fetchFootballTeams = _props.fetchFootballTeams;

      var promises = [fetchUser(), fetchMaritalStatus()];
      ...
      Promise.all(promises).then(function (_ref) {
        ...
        _this2.setState({
          ...
          fechaNacimiento: (0, _moment2.default)(user.fechaNacimiento, 'YYYY/MM/DD').toDate(),
        ...
        return _this2.setState({ clubs: teams ? teams : [] });
      }).then(function () {
    ...
    value: function handleCountryChange(e) {
      ...
      this.props.fetchFootballTeams(countryId).then(function (teams) {
        _this4.setState({
          clubs: teams
        });
      });
    ...
    value: function handleSubmit(e) {
      ...
      var birthdate = this.state.fechaNacimiento;
      ...
      if (this.state.isImageLoaded) {
         ...
         */
        Cordova.exec(this.handleSuccessfulUpdate, this.handleErrorOnUpdate, 'FileTransfer', 'upload', [foto, // filePath
        "http://192.168.1.5:8001" + '/api/user/' + this.props.userId, // Server
        ...
        _axios.request.post('api/user/' + this.props.userId, data, {
          headers: {
            Authorization: 'Bearer ' + this.props.accessToken
          }
        }).then(function (res) {
          return _this6.handleSuccessfulUpdate({
            response: JSON.stringify(res.data)
          });
        }).catch(function (e) {
          return _this6.handleErrorOnUpdate({
    ...
    value: function handleSuccessfulUpdate(res) {
      console.log('res', res);
      if (res.response) {
        var client = JSON.parse(res.response);
    ...
    key: 'handleErrorOnUpdate',
    value: function handleErrorOnUpdate(err) {
      console.log('err', err);
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          foto = _state.foto,
          fechaNacimiento = _state.fechaNacimiento;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { method: 'POST', className: 'p-4', onSubmit: this.handleSubmit },
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(_ProfileImage2.default, {
              ...
              onRemove: function onRemove(e) {
                return _this7.setState({ foto: null, isImageLoaded: false });
              }
            })
          ),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'address-card', size: 'lg' })
            ),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'input-group-prepend' },
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'calendar', size: 'lg' })
            ),
            _react2.default.createElement('input', {
              readOnly: true,
              id: 'fecha',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'input-group-prepend' },
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'envelope', size: 'lg' })
            ),
            _react2.default.createElement('input', {
              readOnly: true,
              type: 'text',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'input-group-prepend' },
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'venus-mars', size: 'lg' })
            ),
            _react2.default.createElement(
              'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'input-group-prepend' },
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'user-circle', size: 'lg' })
            ),
            _react2.default.createElement(
              'span',
              { className: tagClass },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'input-group-prepend' },
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'phone', size: 'lg' })
            ),
            _react2.default.createElement('input', {
              type: 'number',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'globe-americas', size: 'lg' })
              )
            ),
            _react2.default.createElement(
              'div',
              { className: 'form-check form-check-inline' },
              _react2.default.createElement('input', { className: 'form-check-input', onChange: this.handleCountryChange, type: 'radio', name: 'pais', id: 'inlineRadio1', value: '5caf334dff6eff0ae30e450b', checked: pais === '5caf334dff6eff0ae30e450b' }),
              _react2.default.createElement(
                'label',
            ...
            _react2.default.createElement(
              'div',
              { className: 'form-check form-check-inline' },
              _react2.default.createElement('input', { className: 'form-check-input', onChange: this.handleCountryChange, type: 'radio', name: 'pais', id: 'inlineRadio2', value: '5caf37adff6eff0ae30e450d', checked: pais === '5caf37adff6eff0ae30e450d' }),
              _react2.default.createElement(
                'label',
          ...
          this.state.pais !== '' && _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'input-group-prepend' },
              _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: 'futbol', size: 'lg' })
            ),
            _react2.default.createElement(
              'select',
          ...
          this.state.equipo !== '' && _react2.default.createElement(
            'div',
            { className: 'text-center contenedor-imagen-equipo' },
            _react2.default.createElement('img', { className: 'imagen-equipo', src: '/images/clubs/' + this.state.equipo + '.png' })
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'button',
              { type: 'submit', className: 'btn btn-negro black btn-box-index' },
              'Actualizar'
            )
          )
        )
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    fetchMaritalStatus: function fetchMaritalStatus() {
      return dispatch((0, _app.fetchMaritalStatus)());
    },
    fetchFootballTeams: function fetchFootballTeams(countryId) {
      return dispatch((0, _app.fetchFootballTeams)(countryId));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CambiarDatos);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./CambiarDatos.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./CambiarDatos.css");
...
// module
exports.push([module.i, ".boton-fecha {\r\n    border: 1px solid #fff;\r\n    padding-top: 0.5rem;\r\n    padding-bottom: 0.5rem;\r\n    width: 87%;\r\n    color: #dadada;\r\n}\r\n\r\n.icono-fecha {\r\n    font-size: 1.714em;\r\n}\r\n\r\n.contenedor-imagen-equipo {\r\n    margin-bottom: 15px;\r\n}\r\n\r\n.imagen-equipo {\r\n    height: 4rem;\r\n}\r\n\r\n.form-inside {\r\n    width: 320px;\r\n    background: #202020;\r\n    border-radius: 5px;\r\n}\r\n", ""]);
