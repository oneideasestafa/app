...
<div aria-hidden="true" class="navdrawer" id="navdrawerDefault" tabindex="-1">
    <div class="navdrawer-content">
        ...
        <div id="menu" data-menuapp="{{ json_encode(menuApp(Auth::user()->Evento_id)) }}"  data-tipocuenta="{{ Auth::user()->TipoCuenta }}"  data-pais="{{ (string)(Auth::user()->Pais_id) }}" data-url="{{ url('/') }}" ></div>
